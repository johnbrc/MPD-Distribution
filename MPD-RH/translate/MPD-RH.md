...
> The Syllabus consists of a Resource Handbook and  15 Module Handbooks. Each module consists of 4 studies; each study contains 3-5 topics. Each topic is accompanied by scripture ratings and three reflective discussion questions. A total of ~240 topics and over 600 reflective questions.

## The Maize Plant Metaphor ##

Jesus referred to his mission using the metaphor of a seed.[^fn1] Seeds enter the ground and die. Yet from their 'death' comes a harvest. The Maize Plant Discipleship Syllabus builds on this metaphor, relating to life, death, growth and sustenance: 
...
This metaphor provides the basic structure of the syllabus, which is divided into two main parts: *Roots and Fruits* and *Sunlight and Rainfall*.
...
:	(un-capitalised) — localised congregations of Messianic Community. The term emphasises local communities living under the lordship of the Messiah. It also emphasises the link to the whole body of the Messiah, the Messianic Community. Equivalent to *congregations.*
...
-	How does the seed metaphor feature in the ministry of Jesus?
...
![Generational discipleship][MPD-M1-generational.png]
...
[MPD-M1-hear.png]: MPD-M1-hear.png width=108px height=108px

[MPD-M1-retain.png]: MPD-M1-retain.png width=108px height=108px

[MPD-M1-open.png]: MPD-M1-open.png width=108px height=108px

[MPD-M1-share.png]: MPD-M1-share.png width=108px height=108px

[MPD-M1-pray.png]: MPD-M1-pray.png width=108px height=108px

[MPD-M1-act.png]: MPD-M1-act.png width=108px height=108px

[MPD-M1-cycle.png]: MPD-M1-cycle.png width=247px height=275px

[MPD-M1-metaphor.png]: MPD-M1-metaphor.png width=299px height=445px

[MPD-M1-generational.png]: MPD-M1-generational.png width=267px height=41px

[MPD-M1-icons.png]: MPD-M1-icons.png width=250px height=53px
