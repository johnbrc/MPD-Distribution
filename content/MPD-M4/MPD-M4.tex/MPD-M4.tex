...
\subsection{Terms used in this Study}
...
Use \textbf{Discussion 1} now, or continue to \textbf{God's commissioning} (\autoref{godscommissioning}) and use \textbf{Discussions 1--4} together after completing the whole of this Study
...
Use \textbf{Discussion 2} now, or continue to \textbf{Commissioned as disciples} (\autoref{commissionedasdisciples}) and use \textbf{Discussions 1--4} together after completing the whole of this Study 
...
Use \textbf{Discussion 3} now, or continue to the \textbf{Summary} and then \textbf{Discussions 1--4} to complete this Study
...
The foundational strategy of messianic mission is \textbf{prayer}.

\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=\textwidth,height=25pt]{pray.png}
...
Prayer that is \emph{strategic} is not an afterthought, or a response to crisis. It is a forward-thinking, planned priority. Before reaching out towards others, we need to spend time in prayer, so that God may begin to deal with our faults and empower us with his Spirit.
...
Use \textbf{Discussion 1} now, or continue to \textbf{The strategy of reaching} (\autoref{thestrategyofreaching}) and use \textbf{Discussions 1--4} together after completing the whole of this Study
...
The second strategic step is \emph{reaching people}, in order to bring reconciliation with God, through the Messiah (\autoref{reach}).

\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=\textwidth,height=25pt]{pray-reach.png}
...
Use \textbf{Discussion 2} now, or continue to \textbf{The strategy of discipling} (\autoref{thestrategyofdiscipling}) and use \textbf{Discussions 1--6} together after completing the whole of this Study
...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=\textwidth,height=25pt]{pray-reach-disciple.png}
...
Use \textbf{Discussion 3} now, or continue to \textbf{The strategy of teaching} (\autoref{thestrategyofteaching}) and use \textbf{Discussions 1--6} together after completing the whole of this Study
...
The \emph{fourth} strategy is \emph{teaching} (\autoref{teach})

\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=\textwidth,height=25pt]{pray-reach-disciple-teach.png}
...
Use \textbf{Discussion 4} now, or continue to \textbf{The strategy of sending} (\autoref{thestrategyofsending}) and use \textbf{Discussions 1--6} together after completing the whole of this Study
...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=\textwidth,height=25pt]{pray-reach-disciple-teach-send.png}
...
Use \textbf{Discussion 5} now, or continue to the \textbf{Summary} and then \textbf{Discussions 1--6} to complete this Study
...
\begin{enumerate}
\item [Introducing the trialogue]
...
\autoref{foundational-structures} represents a trialogue of the three foundational structures of messianic community:
...
In its pastoral, shepherding role the community reflects the affirming, self-less, humble, protective, overseeing care that the \emph{Good Shepherd}, Jesus, has for his people. This is demonstrated practically through being both an \emph{hospitable} and a \emph{celebratory, worshipping} community.
