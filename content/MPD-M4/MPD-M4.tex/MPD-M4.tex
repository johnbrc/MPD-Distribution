...
\begin{figure}[htbp]
\centering
\includegraphics[width=243pt,height=250pt]{commissioncycle.png}
\caption{}
...
Teaching and training centres supplement the formation of disciples taking place within pastoral, evangelistic communities (\autoref{pastoralevangelisticcommunities}). Their function is to equip mature messianic disciples for missional, vocational service, in both \emph{intra-cultural} and \emph{inter-cultural} contexts, which together signify the full scope of messianic mission: God's servant community, blessed to be a blessing to \emph{all the peoples} of the world—yet between which there are significant differences.
...
The prophetic ministry fulfils a dual mediatory role, incorporating both \emph{priestly} and \emph{prophetic} mediation. 

\begin{itemize}
\item Priestly mediation involves speaking with God, as a representative of the Messianic Community.

\item Prophetic mediation involves speaking with the Messianic Community, as a representative of God.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=250pt,height=239pt]{structuralinteractions.png}
...
\begin{itemize}
\item Identify all of the different interactions between the three foundational structures. Which of the different structural dynamics are most significant? Why?
...
\osection{Bonus Discussions: Study 3}
\begin{disc}[Messianic structures and the prophetic gift]
