...
\begin{figure}[htbp]
\centering
\includegraphics[width=124pt,height=124pt]{apostolicmissionaryteams.png}
\caption{}
...
Priestly mediation involves speaking with God, as a representative of the Messianic Community, whereas prophetic mediation involves speaking with the Messianic Community, as a representative of God

\begin{description}

\item[Priestly mediation]

involves sharing the intercession of the Holy Spirit, by faithfully modelling, advocating and encouraging the vital mediatory work of intercessory prayer.\footnote{Romans 8:26--27} It must be based upon a purity of heart and faithfulness of life that enables practitioners to offer effective intercession on behalf of others.\footnote{James 5:13--20; Psalm 24:3--4; also \emph{Module 8: The Dynamic of Intercession}.}

\item[Prophetic mediation]

involves providing discernment, direction and insight, regarding contextual and historical challenge, opportunity and responsibility and providing exhortation, clarification, even rebuke, when messianic communities are failing in their vocational calling to serve God's purposes as \emph{a house of prayer for all nations}.\footnote{Matthew 21:13, c.f. Isaiah 56:7} It is based upon practitioners capacity for \emph{hearing what the Spirit is saying to the Messianic Community}.\footnote{Revelation 2:7,11,17,29,3:13,22; also Matthew 11:15, Mark 4:9, Luke 8:8 etc.}
\end{description}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=179pt,height=210pt]{pickingupgodsheartbeat.png}
\caption{}
...
These correspondences are not intended to be definitive or exclusive. They simply illustrate how different parts of the body contribute significantly to the functioning of the whole body, so that the Messianic Community is able to function according to God's unique plan, purpose and vocation:
...
Organic \emph{increase} in plant growth potentially produces a thousand-fold \textbf{multiplication} of seeds, often twice a year, allowing rapid crop \emph{expansion}, depending upon climate and soil conditions.
...
Logistical growth, measured by \emph{increase} in profits, personnel and management experience, leading to \textbf{duplication} of structures (premises and management hierarchy) and geographical \emph{expansion} of the market being served.
...
Ultimately, the Holy Spirit is responsible for governing the wild, haphazard growth of a missional, discipling movement capable of impacting communities, regions and even nations, over time.\footnote{The wind breathes where it wills; and though you hear its sound, yet you neither know where it comes from, nor where it is going. So it is with everyone born of the Spirit—John 3:8 ABV}
...
\vspace{25pt}\osection{Conclusion of Module 4}
