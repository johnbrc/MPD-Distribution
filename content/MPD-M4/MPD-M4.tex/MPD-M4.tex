...
\begin{mdframed}[Topics in Study 1]

\begin{enumerate}
\item \textbf{The Commissioning of Messianic Community}

\item \textbf{The Strategies of Messianic Community}

\item \textbf{The Structures of Messianic Community}

\item \textbf{The Expansion of Messianic Community}
...
Guidelines on appropriately facilitating study groups and discussions (as well as significant background information) is incorporated in the \emph{Maize Plant Discipleship Facilitators Handbook}, available from the same source as this handbook. 

\begin{mdframed}[style=info]

\emph{Further information is available at the website:}
...
\begin{topic}[Military commissioning]

Use \textbf{Discussion 1} now, or continue to \textbf{God's commissioning} (\autoref{godscommissioning}) and use \textbf{Discussions 1--4} together after completing the whole of Study 1
...
\begin{mdframed}[style=discuss]

\begin{quote}

Use \textbf{Discussion 2} now, or continue to \textbf{Commissioned as disciples} (\autoref{commissionedasdisciples}) and use \textbf{Discussions 1--4} together after completing the whole of Study 1
\end{quote}
...
Use \textbf{Discussion 3} now, or continue to the \textbf{Summary} and then \textbf{Discussions 1--4} to complete Study 1
\end{quote}
...
Related to \emph{The strategy of praying} (\autoref{thestrategyofpraying}) 
...
Related to \emph{The strategy of reaching} (\autoref{thestrategyofreaching}) 
...
Related to \emph{The strategy of discipling} (\autoref{thestrategyofdiscipling}) 
...
Related to \emph{The strategy of teaching} (\autoref{thestrategyofteaching})
...
Related to \emph{The strategy of sending} (\autoref{thestrategyofsending})
