\def\version{0.4.8 "Journey's End"}
\def\change{finalising production draft}
\input{mpd-header}
...
means that a soldier will be required to undergo basic training again, until they pass satisfactorily—or they leave military service altogether.

\item[Success]

means a soldier is equipped and authorised for \emph{active service}: capable, ready and trusted to fulfil their duties, which include general soldiering \emph{and} personal vocational duties—such as those of infantry, driver, engineer, medic, officer, chef and so on.
\end{description}

\subsection{Commissioning}
\label{commissioning}

\textbf{A soldier's commissioning} represents the beginning of their \emph{active service}, as a member of a specific regiment of the army. Historically, soldiers are commissioned ceremonially by the national sovereign—the King or Queen—providing a vivid illustration of the calling to ``serve the crown,'' as a loyal subject.
...
The English word, \emph{mission\footnote{From Latin \emph{missio}, meaning \emph{sending}}} was originally used exclusively to refer to God's active sending of himself, into the world, to restore it from the effects of human wickedness, idolatry, chaos, spiritual darkness, oppression, injustice and evil.\footnote{\emph{Missio Dei}---an increasingly widespread theological concept; closely equivalent with \emph{God's eternal purpose} (Module 1).} This is seen in three particular ways. 

\begin{description}

\item[The Old Testament reveals God's glorious Presence]

most vividly as a pillar of cloud and fire during the exodus from Egypt, within the Tabernacle of Meeting, above the Ark of the Covenant and at Solomon's dedication of the temple.\footnote{The Hebrew word, \emph{Shekinah} refers to the ``Glorious Presence of God Dwelling Amongst His People''—see Exodus 13:17--14:29; Exodus 40; 2 Chronicles 7; also Luke 2:9, Hebrews 1:3; 1 John 1:14, 2 Peter 1:17; Matthew 17:6 etc.}

\item[The New Testament reveals the Messiah, Jesus]

as \emph{Lamb of God, apostle, high priest\footnote{John 1:29; Hebrews 3:1 (4:14--16)}} and \emph{the radiance of the (Shekinah) glory, the very expression of God's essence{\ldots}the visible image of the invisible God\footnote{Hebrews 1:1--4; Colossians 1:15,19}}—in every way Jesus the Messiah reflects the reality that God the Father is a missional god.
...
Those who hear and respond to a calling to military service are commissioned only after satisfactorily completing basic training. Jesus' words, \emph{Many are called, but few are chosen}\footnote{Matthew 22:1--14} similarly suggests that hearing the call to serve God's mission is only the start.
...
The process of \emph{calling, training and commissioning} is therefore how we are prepared for useful service.\footnote{2 Timothy 2:20--21} It is how we become co-workers with the Messiah in his mission. And it how we become \emph{chosen} by the Messiah: appointed and empowered to work alongside him, gathering a \emph{harvest of faithfulness},\footnote{Hebrews 12:11} in the power of his Spirit.
...
\item Describe the responsibility imparted by the giving and receiving of a commission.
...
When Jesus proclaimed the kingdom of God in Israel, he compared a ripe, abundant crop harvest to crowds of distressed and dejected people, who were to him \emph{like sheep without a shepherd.} Then he said to his disciples:
...
Although the harvest is plentiful, Jesus identifies a problem: a shortage of labourers ready and willing to gather it. There is a shortage of trained disciples, ready to be commissioned into service. 
...
\textbf{\emph{Pray to the Lord of the harvest{\ldots}to force and thrust out labourers into the harvest field}}!
\end{quote}

This is the starting point of strategic mission: focussed prayer that workers—disciples—loyal to Lord of the harvest would be thrust towards wholeheartedly serving God's eternal purpose.
...
Paul refers to \emph{the word of God in its fullness} or \emph{the whole counsel of God.\footnote{Colossians 1:25; also Acts 20:27 ff.}} Experiencing this fullness requires holding together, in appropriate tension, three complementary strands of biblical teaching: \emph{pastoral-evangelistic, prophetic} and \emph{apostolic}.
...
The peculiar demands of intercultural ministry can mean that it does not rest easily alongside parochial concerns. As a result pastoral-evangelistic communities and apostolic, missionary agencies often end up operating separately—to the detriment of both. Prophetic insight and teaching can help to bridge the gap between them.

\subsection{Spiritual revelation}
\label{spiritualrevelation}

The \emph{spirit of wisdom and revelation\footnote{Ephesians 1:16--19}} plays a vital role in messianic teaching and understanding. The disciples experienced this when they met the risen Messiah.
...
\osection{Summary: Study 2}

This concludes Study 2, \emph{The Strategies of Messianic Community}, which explored five foundational, missional strategies: strategic prayer, reconciliation with God, formation of disciples, teaching the spiritually mature, sending people into mission. These five strategies can be summarised as a cycle: \emph{pray, reach, disciple, teach, send}.
...
\end{disc}
\begin{disc}[relating to T4, Teaching]
...
\end{disc}
\begin{disc}[relating to T5, Sending]
...
Pastoral evangelistic communities are defined by their dual pastoral \emph{and} evangelistic character.\footnote{Pastoral, evangelistic community is expressed contextually as \emph{local church}.} 
...
Teaching and training centres supplement the formation of disciples taking place within [pastoral, evangelistic community]. Their function is to equip mature messianic disciples for missional, vocational service, in both \emph{intra-cultural} and \emph{inter-cultural} contexts.
...
There are significant and important differences relating to intra- and inter-cultural contexts. Together they represent the fulness of messianic mission: to serve God's eternal purpose, blessed to be a blessing to all the peoples of the world—those both near \emph{and} far away.
...
\label{architectlayingamessianicfoundation}

Paul compares the apostolic missionary role to that of a skilful architect, or \emph{master builder}, laying a Messianic foundation.\footnote{I Corinthians 3:10--15} 

\begin{itemize}
\item Thus, apostles and apostolic missionary teams are responsible to pioneer the formation and establishment of pastoral, evangelistic communities (\autoref{pastoralevangelisticcommunities}) and messianic teaching and training centres (\autoref{teachingandtrainingcentres}). These messianic structures are then handed over to local, contextual leaders, as the apostle moves on to other fields of work.

\item Because apostolic work is laying a foundation upon which others will build, its quality is crucial to the future of the messianic community in those settings. Apostolic work is especially critical to intercultural contexts.

\end{itemize}

\subsection{Ambassador—acting as the Messiah's representative}
\label{ambassadoractingasthemessiahsrepresentative}

Paul compares to the responsibility of representing the Messiah amongst people of other nations or cultures, as that of \emph{ambassadors of the Messiah}.\footnote{2 Corinthians 5:20--21} 

\begin{itemize}
\item Thus, apostles and apostolic missionary teams cross geographical and cultural boundaries in order to represent and to pioneer messianic community amongst people and places where there are no, few or waning gospel communities.

\item Living and working inter-culturally, in non-native contexts, places significant additional demands upon workers, because of differences encountered in a whole range of experiences, including language, climate and food; political, economic and bureaucratic systems; customs, social expectations and religious sensibilities.
...
Yet for all the reasons discussed, apostolic work is especially demanding for practitioners. Thus Paul, who experienced many trials and tribulations, identifies his apostolic, missionary service with being \emph{put on display at the end of the procession}.\footnote{2 Corinthians 4:7--12 \& 6:3--10; 1 Corinthians 4:9--13} 

\begin{itemize}
\item Paul is referring to the apostolic missionaries' need to risk humiliation and all manner of difficult challenges, for the sake of furthering the message of the Messiah. 

\item Through sacrificial dedication, endurance of suffering, embrace of humility and deep-seated reliance upon the power of the Holy Spirit, apostolic workers provide a profound example to the whole Messianic Community, of our \emph{shared calling} to faithful missional service.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=177pt,height=177pt]{pioneeringpower.png}
\caption{}
...
\item discern and share God's \emph{kairos\footnote{Greek, referring to a particularly opportune, favourable, suitable or appropriate moment--e.g. see John 7:6--8, 12:23; Luke 21:13; Mark 13:4; Acts 1:6--7; 1 Timothy 2:6; \emph{kairos} contrasts with \emph{chronos}, referring to fixed, measurable units of time.}} word for a particular context.
...
Ultimately, the prophetic ministry fulfils a dual mediatory role, incorporating both \emph{priestly} and \emph{prophetic} mediation.
...
sharing the intercession of the Holy Spirit, by faithfully modelling, advocating and encouraging the vital mediatory work of intercessory prayer;\footnote{Romans 8:26--27}

based upon a purity of heart and faithfulness of life that enables them to offer effective intercession on behalf of others.\footnote{James 5:13--20; Psalm 24:3--4; also \emph{Module 8: The Dynamic of Intercession}.}

\item[Prophetic mediation]

involves speaking with the Messianic Community, as a representative of God:

providing discernment, direction and insight, especially regarding contextual and historical challenge, opportunity and responsibility;

providing exhortation, clarification, even rebuke, particularly when messianic communities are failing in their vocational calling to serve God's purposes as \emph{a house of prayer for all nations}.\footnote{Matthew 21:13, c.f. Isaiah 56:7}

based upon a capacity for \emph{hearing what the Spirit is saying to the Messianic Community}.\footnote{Revelation 2:7,11,17,29,3:13,22; also Matthew 11:15, Mark 4:9, Luke 8:8 etc.}
\end{description}
...
\emph{The Strategies of Messianic Community} (\autoref{thestrategiesofmessianiccommunity}) illustrated and explored five foundational strategies: pray, reach, disciple, teach, send. These five strategies correspond closely with the messianic structures explored in this study. This correspondence is displayed in the table, below.
...
These correspondences are not intended to be definitive or exclusive. They simply illustrate how \emph{different parts} of the body contribute significantly to the functioning of the \emph{whole} body, so that the Messianic Community is able to function according to God's unique plan, purpose and vocation:

\begin{quote}

\emph{You are{\ldots}members of the household of God, built upon the foundation of the apostles and prophets, with Christ himself as the cornerstone. In him the whole structure is joined together and grows into a holy temple in the Lord, in whom you also are being built spiritually into a dwelling place for God}—Ephesians 2:19b--22 ABV
\end{quote}
...
The figure below, \emph{Structural interactions}, suggests some specific ways in which the different structural parts of the whole body could interact with the other parts. For example, apostolic missionary teams planting pastoral-evangelistic communities and establishing teaching centres and so on.

\begin{figure}[htbp]
\centering
\includegraphics[width=199pt,height=190pt]{structuralinteractions.png}
...
\osection{Summary: Study 3}

This concludes Study 3, \emph{The Structures of Messianic Community}, which examined the foundational structures of messianic community, including their relation to the five foundational gifts—pastor, evangelist, teacher, apostle and prophet—and the five foundational strategies—pray, reach, disciple, teach, send.
...
\end{disc}
\begin{disc}[relating to T4, Prophets, priests, mediators]
...
\end{disc}
\begin{disc}[relating to T5, Structural Interaction]

\begin{itemize}
\item Identify all of the different interactions between the three foundational structures? 

\item How might the prophetic ministry complements these structural interactions?
...
\subsection{Summary: Honey bees}
\label{summary:honeybees}
...
Organic, steady, cyclical \emph{increase} in bee numbers leads to swarming and eventually a \textbf{division} of the colony, which then \emph{expands} into a different geographical region.
...
The maize plant is a rapidly-reproducing cereal crop, with a leafy stalk, typically growing two or more metres high.

\subsection{Figure: Maize plant}
\label{figure:maizeplant}
...
\subsection{Summary: Maize plant}
\label{summary:maizeplant}
...
Organic \emph{increase}, as each plant grows, potentially producing a thousand-fold \textbf{multiplication} of seeds, often twice a year, allowing rapid \emph{expansion} of crop, depending upon climate and soil conditions.
...
Rewards associated with commercial growth\footnote{A large multinational corporation can easily grow to employ hundreds of thousands of people, in multiple offices, in numerous countries, with a larger economy than small nation states.} typically produces highly competitive, demanding environments. This can lead to extraordinary performance, yet also to a loss of human dignity.
...
Unpredictable, inorganic growth measured by \emph{increase} in profits, personnel and management experience, leading to \textbf{duplication} of structures (premises and management hierarchy) and geographical \emph{expansion} of the market being served.
...
\osection{Summary: Study 4}

This concludes Study 4, \emph{The expansion of Messianic Community} (\autoref{theexpansionofmessianiccommunity}), which explored three examples of either organic or organisational reproduction, in order to compare and contrast them with the organised expansion of messianic, discipleship movements. 
...
\osection{Discussions: Study 4}

\begin{disc}[relating to T1, Honey bees]

\begin{itemize}
\item What is a \emph{collective organism}?
...
\end{disc}
\begin{disc}[relating to T4, Missional movements]
...
\vspace{50pt}\osection{Conclusion of Module 4}

\begin{quote}

You have completed \emph{Module 4} of the Maize Plant Discipleship Syllabus, which explored \emph{God's commissioning} of the Messianic Community, in four inter-related studies:
\end{quote}
...
\textbf{Module 5} of the Maize Plant Discipleship Syllabus explores \emph{Dynamics of Body Membership}. 

For further information see: \emph{Using this Handbook}.
\end{quote}
...
John was awarded a \emph{Doctorate of Missiology (Contextual Missiology)}, in 2013, by Fuller Theological Seminary School of Intercultural Studies. John is presently working to establish the \emph{Ajayi Crowther Centre for African Mission}, in Oxford.
\end{quote}
