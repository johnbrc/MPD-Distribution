...
\begin{figure}[htbp]
\centering
\includegraphics[width=160pt,height=165pt]{commissioncycle.png}
\caption{}
...
Teaching and training centres supplement the formation of disciples taking place within pastoral, evangelistic communities (\autoref{pastoralevangelisticcommunities}). Their function is to equip mature messianic disciples for missional, vocational service, in both \emph{intra-cultural} and \emph{inter-cultural} contexts.
...
There are significant differences between intra- and inter-cultural contexts. Taken together they signify the full scope of messianic mission: God's servant community, blessed to be a blessing to \emph{all the peoples} of the world.

\subsection{Teachers and trainers}
\label{teachersandtrainers}

The role of messianic \emph{teachers} and \emph{trainers} is critical to the formation of mature disciples with a faithful understanding of Scripture, appropriately equipping them for works of service.
...
involves (i) sharing the intercession of the Holy Spirit, through a lifestyle of intercessory prayer;\footnote{Romans 8:26--27} (ii) advocating and encouraging the Messianic Community to be \emph{a house of prayer for all nations}.\footnote{Matthew 21:13, c.f. Isaiah 56:7} It must be based upon a purity of heart and faithfulness of life that enables practitioners to offer effective intercession on behalf of others.\footnote{James 5:13--20; Psalm 24:3--4; also \emph{Module 8: The Dynamic of Intercession}.}

\item[Prophetic mediation]

involves (i) providing discernment, direction and insight, regarding contextual and historical challenge, opportunity and responsibility and (ii) providing exhortation, clarification, even rebuke, when messianic communities are failing in their vocational calling. It is based upon practitioners capacity for \emph{hearing what the Spirit is saying to the Messianic Community}.\footnote{Revelation 2:7,11,17,29,3:13,22; also Matthew 11:15, Mark 4:9, Luke 8:8 etc.}
\end{description}
...
\item How does the prophetic ministry complement the structural interactions?

\item How might the three foundational structures explore responding to the prophetic ministry?
...
You have completed Module 4 of the Maize Plant Discipleship Syllabus, which explored \emph{God's commissioning} of the Messianic Community, in four inter-related studies:
