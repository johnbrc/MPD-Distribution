\def\version{0.4.4 "Synergy"}
\def\change{Publication draft, incorporating extensive Tex commands}
\input{mpd-header}
...
This module explores \emph{God's commissioning} of the Messianic Community, in four inter-related studies:
...
Use \textbf{Discussion 5} now, or continue to \textbf{The strategy of reaching} (\autoref{thestrategyofreaching}) and use \textbf{Discussions 1--4} together after completing the whole of this Study
...
\begin{itemize}
\item Discuss [\emph{Reconciliation}], or
...
Use \textbf{Discussion 5} now, or continue to \textbf{The strategy of reaching} (\autoref{thestrategyofreaching}) and use \textbf{Discussions 5--10} together after completing the whole of this Study
...
\begin{itemize}
\item Discuss [\emph{Discipleship}], or
...
\begin{itemize}
\item Discuss [\emph{Sending}], or

\item Continue to [\emph{Summary}][summary-strategy] and [\emph{Discussions}][strategy]
