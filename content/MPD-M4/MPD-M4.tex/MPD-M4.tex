...
\subsection{Read these passages aloud}
\label{readthesepassagesaloud}

\reversemarginpar

\marginpar{\vskip0cm\hspace{-3cm}\includegraphics[width=\marginparwidth]{people.pdf}}
...
\subsection{Memorise these passages}
\label{memorisethesepassages}
