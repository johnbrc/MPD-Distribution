\def\version{0.4.3 --- Publishing Draft}
\def\change{Replaced ch7 (Information) with ch1 (Using this handbook)}
...
\begin{enumerate}
\item The Commissioning of Messianic Community (\autoref{thecommissioningofmessianiccommunity})

\item The Strategies of Messianic Community (\autoref{thestrategiesofmessianiccommunity})

\item The Structures of Messianic Community (\autoref{thestructuresofmessianiccommunity})

\item The Expansion of Messianic Community (\autoref{theexpansionofmessianiccommunity})
...
Guidelines on appropriately facilitating study groups and discussions (as well as significant background information) is incorporated in the \emph{Maize Plant Discipleship Facilitators' Handbook}, available from the same source as this handbook. For further information please visit the website:
...
This module is number 4 of 16 that comprise the \emph{Maize Plant Discipleship Syllabus}:
