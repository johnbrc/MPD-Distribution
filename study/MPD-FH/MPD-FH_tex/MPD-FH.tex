\def\version{0.4.0 --- Translation Draft}
\def\change{Issued for translation}
\input{mpd-header}
...
\def\email{clements.jb@icloud.com}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=233pt,height=225pt]{learning-cycle.png}
...
\item[Consider traditional proverbs relating to study topics —]
...
\begin{figure}[htbp]
\centering
\includegraphics[width=244pt,height=275pt]{mpd-learning-cycle.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=299pt,height=271pt]{MetaphorSECONDDRAFT.png}
\label{metaphorseconddraft.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=283pt,height=142pt]{SoilandRootsSEVENTHDRAFT.png}
\label{soilandrootsseventhdraft.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=277pt,height=389pt]{MaizePlantSECONDDRAFT.png}
\label{maizeplantseconddraft.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=283pt,height=397pt]{SunlightandRainfallEIGHTHDRAFT.png}
\label{sunlightandrainfalleighthdraft.png}
\end{figure}
...
In the Maize Plant Discipleship syllabus, \emph{vocation} and \emph{vocational} refers to both personal and communal calling. Within the syllabus, the terms are used to emphasise that both an individual and a local community's sense of vocation flow from the divine calling to serve God's eternal purpose, in union with the Messiah.

Vocation also represents an umbrella term that incorporates and dignifies all forms of work and ministry. It looks beyond traditional divides of laity and clergy, male and female, by pointing towards the reality that all followers of the Messiah are \emph{called to faithfully serve God's purposes, within homes, workplaces and communities}. 
\end{description}
...
It is a body learning to walk in the footsteps of Jesus: learning to exercise its God-appointed, mediatory, intercessory, messianic role, under the direction of the Spirit of God.\footnote{Romans 6:3--4; Galatians 3:26--29; Hebrews 6:4}\begin{description}

\item[This community of disciples is]
...
\item Encouraging contextual, vernacular adaption.
...
\begin{itemize}
\item Allowing republication, translation and low cost sales

\item Upholds author's and translators' copyrights

\item Releases tight control over republication.
...
\item[Are you aware of stories, proverbs, metaphors —]
...
\item[The Creative Commons Licence]
...
Maize Plant Discipleship by John B. Clements is licensed under a \textbf{Creative Commons Attribution-ShareAlike 4.0 International License}. Based on a work at http:/\slash johnbrc.github.io\slash MPD-Distribution\slash 

\begin{quote}

\emph{Note: What follows is a simplified summary of (and not a substitute for) the licence, which may be accessed at: http:/\slash creativecommons.org\slash licenses\slash by-nc-sa\slash 4.0\slash }
\end{quote}
...
\item \textbf{NonCommercial} - NonCommercial — You may not use the material for commercial purposes (i.e. primarily intended for commercial advantage or monetary compensation.)
