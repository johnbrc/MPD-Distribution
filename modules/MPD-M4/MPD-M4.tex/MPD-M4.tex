...
\begin{figure}[htbp]
\centering
\includegraphics[width=155pt,height=160pt]{commissioncycle.png}
\caption{}
...
\begin{itemize}
\item Briefly discuss each of the identified interactions (send, supply {\ldots} etc) between the three foundational structures. Which of the different structural dynamics are most significant? Why?
...
\includegraphics[width=135pt,height=99pt]{john-rhossilli.jpg}is
