...
Jesus' role as messianic king, however, is not obvious: at no time does he occupy an established political position—as kings normally must. Nor does he seek to lead a military rebellion. From the Gospels, through to the apostolic epistles, there is a significant development of Jesus' identification:

\begin{enumerate}
\item The Prophet \emph{like Moses\footnote{Also: initially \emph{rabbi}—a recognised religious office, yet with no messianic overtones and thus no threat to Israel's established leadership.}}

\item The Messiah, \emph{Branch of David}

\item Eternal High Priest, \emph{seated at God's right hand}.
...
\begin{itemize}
\item \emph{Announces} the arrival of \emph{the kingdom of God}—a declaration that God is about to act decisively in the history of Israel.\footnote{Mark 1:14--15} 
...
At the time of Jesus, \emph{Pharisees} and \emph{Sadducees} exercise this position. Jesus does not challenge their holding this important office, rather he holds them responsible for the ongoing corruption of the covenant relationship: criticising them for publicly going through the motions of Torah-obedience, yet with \emph{uncircumcised hearts}, neglecting the \emph{greater commandments} of humility, mercy and justice, whilst making covenant faithfulness harder for others.\footnote{So strong was his denunciation that Jesus actually curses them, saying: \emph{Woe to you}{\ldots}—a recognised form of curse (Matthew 23). If issuing a curse seems harsh, there is ample precedent within the history of Jewish prophets. \emph{Note}: the cursing of the fig tree (Matthew 17) is a metaphor, acted out by Jesus as a prophetic warning directed against the corrupted, incumbent leadership—\emph{not} the Jewish people in general. Moreover, the gospels reveal that amongst them some individuals were \emph{close to the kingdom}; some became disciples (Mark 12:28--34).}
...
\section{High Priest ``of the order of Melchizedek''}
\label{highpriestoftheorderofmelchizedek}

As priest, the Messiah affects three highly significant realities: 

\begin{itemize}
\item He makes purification for sins

\item He sits down at the right hand of God

\item He lives forever, interceding for human beings.

\end{itemize}

These three realities represent the heart of the New Covenant and thus the consummation of the Messiah's work. The book of \emph{Hebrews} deals with these things in great detail, nevertheless, each idea is originally encountered in the gospels.
...
\subsection{Messiah: prophet, king, priest}
...
The final aspect of the Messiah's role is as Israel's true \emph{cohen hagadol} (``\emph{high priest}''), inaugurating and guaranteeing a new, superior covenant, which the writer of Hebrews identifies as both the new covenant, prophesied by Jeremiah, made with \emph{the House of Israel and Judah}.\footnote{Jeremiah 31:31--34} and \emph{the eternal covenant}.
\end{description}

The Messiah mediates this new covenant as a sinless and eternal high priest, unlike the Levitical high priests who went before, under the terms of the Sinai covenant, whose own sin meant that they could only enter the earthly tabernacle once a year. Instead the Messiah, serves in{\ldots} 
