...
\textbf{Maize Plant Discipleship} is an open educational resource, derived and road-tested in collaboration with Africans. It has been formulated in response to contextual doctoral research in Burkina Faso to be practical, relevant and accessible for use in majority-world contexts. 
...
\begin{enumerate}
\item \textbf{The Eternal Purpose of God}
...
The \emph{Maize Plant Discipleship Facilitators Handbook}—available from the same source as this handbook, or via the Internet—contains comprehensive guidelines on appropriately facilitating Maize Plant Discipleship learning groups and discussions.
...
Mark these passages for reading aloud, either now or as referenced in the study topics. The \textbf{bold} passages are marked for memorisation, in time for the next meeting.
...
\item Israel's journey towards and into the \textbf{land} promised to Abraham (Joshua)
...
Each of these biblical events are represented below, as a series of lines that together form a \emph{story-based timeline of biblical history}.
...
Nevertheless, by looking carefully at the inner content of these historical narratives, it is possible to discern another, more profound pattern—one which flows through the whole of Scripture: \emph{a series of divine covenants}. 
...
\item The covenant established with Israel, in the wake of the exodus from Egypt\footnote{Exodus 19.4–6}
...
The establishment of a covenant signifies the formation of a solemn bond, \emph{commitment} or \emph{obligation} binding together individuals, families, tribes and nations. Covenants may be negotiated, including weaker parties approaching stronger ones. Where one party is recognisably or assertively stronger than the other, such as a conqueror or \emph{deliverer} in contexts of war, it imposes or dictates covenant terms to the weaker, conquered or rescued party:

\begin{itemize}
\item The more powerful tribe or nation offers protection, land and reward, in the name of their leader or commander. 

\item The lesser or subjugated tribe or nation becomes a servant-people, promising allegiance, military service and payment of taxes.

\end{itemize}

\subsection{Biblical use}
\label{biblicaluse}

The Hebrew word translated \emph{covenant} is \emph{berîyth}. It occurs over 250 times in the Old Testament, where it refers to a formal, binding arrangement between two parties, such as a treaty, constitution, agreement, alliance, pledge or oath. The same word is used when referring to both secular and divine covenants. 

Within biblical use, \emph{berîyth} is frequently combined with another Hebrew word that means \emph{to cut}. Together they provide the phrase, \emph{to cut covenant.} This refers to the knife cut that kills a sacrificial animal, with the subsequent sprinkling of its blood, prior to a ritual meal—a vital elements of the ritual ceremony by which a covenant is formed.

\subsection{Terms and oaths}
\label{termsandoaths}

\begin{itemize}
\item \emph{Terms} accompany the formation of covenants. These terms prescribe behaviours that constitute either the \emph{keeping} (maintainence) or the \emph{breaking} (violation) of the covenant relationship. 

\item Covenant terms could include: trade, food, water or other resources; skill-sharing; land, routes, territory; taxes; ceremony, tradition; protection, allegiance, peace or war. For a conquered tribe, terms could be benign and generous or oppressive and dominating.

\item Covenant parties swore \emph{oaths} to uphold the terms. These oaths were pronounced to the accompaniment of invocations consisting of: \emph{blessings} (rewards, bounty) for keeping covenant and \emph{curses} (sanctions, punishments) for violating it.
...
\textbf{Covenant refers to a binding obligation forming a solemn relationship between two parties}. A sacrificial meal and spoken oaths confirm the covenant relationship: blessings prescribe rewards for covenant faithfulness to the covenant; curses prescribe sanctions for violating the covenant.
...
In particular, the formation of each covenant incorporates two vital elements: the \emph{calling} of a covenant community and the \emph{purpose} of the covenant, which the covenant community is called to serve.

\subsection{The vocation of the covenant community}
\label{thevocationofthecovenantcommunity}

With each covenant it becomes apparent that God is setting apart a family, a tribe, a nation, a people—\emph{a covenant community}—the faithfulness of whom forms a vital key to the establishment, service and success of God's wider purposes for his creation. They are \emph{a servant community, a community called to serve God's purposes.}

As they serve God's purpose, the covenant community is chosen and favoured, blessed, by God. This blessing is not an end in itself, but a \emph{means} to an end: the covenant community is blessed by God in order that they can serve God's purposes effectively. 
...
\subsubsection{Keeping covenant}
\label{keepingcovenant}

\emph{Keeping covenant} means faithfully observing and preserving the solemn relationship and the obligations set out by the covenant. It means submission and obedience to the terms of the covenant—including seeking forgiveness and restitution, following breaches of covenant. 

Yet, it means more than simply upholding the fine details of the covenant terms. Being faithful to God's covenant means recognising, accepting and co-operating with the \emph{vocation of the covenant community}. This is the reason that God calls a community into covenant with him: that they may become a servant community, \emph{called to serve the eternal purpose of God}.

\subsubsection{Breaking covenant}
\label{breakingcovenant}

Because the \emph{covenant relationship} is always greater than the specific terms of a covenant, occasional breaches can be repaired and the covenant relationship \emph{restored}. Restoration happens through a recognition of breaches (\emph{confession}), restitution (\emph{forgiveness}) and recommitment (\emph{renewal}).
...
\emph{Why is the breaking of covenant such a serious matter?} 

Not because God is a harsh judge. It is because it frustrates his purposes for the covenant. When God's \emph{covenant community} fails to uphold the \emph{covenant relationship} they cannot fulfil their \emph{covenant vocation}.
...
The writer explains that God's purpose in swearing an oath is to \emph{demonstrate the unchangeable character of his intentions}. This confirms that God won't change his mind. He will do what he has purposed and promised to do through his covenants and through his Covenant Community.

Even if God's people break the covenant, \emph{God remains faithful} to his covenant purposes and upholds his sworn obligation. Because his character is unchanging, his unchanging, eternal purpose remains intact. When God makes a covenant he is committing himself to fulfilling his divine purpose through that covenant.
...
\item How might this effect your thoughts about sicknesses and other problems sometimes associated with curses?
...
\textbf{Read Genesis 6:18, 8:6--22 and 9:8--16}

God reminds Noah that he \emph{made human beings in his image}, and instructs Noah's family to \emph{Be fruitful and multiply, swarm over the earth and multiply on it}—echoing the original creation \emph{blessing} given to Adam. 

Scripture refers to God \emph{establishing his covenant} with not only Noah, but also with \emph{his descendants, all the inhabitants of the earth, every living creature} and \emph{with the earth" }itself. A sign accompanies this covenant: a rainbow will serve as perpetual reminder of God's covenant promise to never again destroy all living things.
...
\textbf{Read Genesis 12:1--3, 15.18, 17.1--22, 22.15}

God's covenant with Abraham represents God's response towards the rebellion, degeneration and wickedness of human society, recorded in Genesis chapters 1--11. It reveals God's plan for \emph{a great nation} that will bless all \emph{the families of the earth}. The covenant thus operates in two complimentary directions: 

\begin{itemize}
\item \emph{Downwards} through the generations of Abraham's descendants, who are blessed \emph{in Abraham}.

\item \emph{Outwards} towards the whole human family, who are to be blessed \emph{by Abraham}.

\end{itemize}

Thus, the covenant contains more than a promise; it includes a subtle command: \emph{you are to be a blessing}. This suggests Abraham is intended to convey his sense of promise, protection, blessing and divine purpose to the tribes and peoples with whom he relates. Because of his covenant with God, he is to anticipate being a blessing to others.
...
\textbf{Read Exodus 19.4--6, 6:2--6; Leviticus 26.9; Deuteronomy 4:5--6, 8.18, 28:1; Isaiah 42:6; Ezekiel 16.60--62; Romans 9:4--9}

A covenant is formed with the nation of Israel, against the backdrop of a powerful deliverance and \emph{exodus} from the oppression of Egypt's Pharaoh. Abraham's descendants, the \emph{sons of Israel,} acknowledge God (YHWH) as their powerful and faithful Deliver, who has brought them to the point of entering the sanctuary of the land promised to their ancestors.

Again, two perspectives are discernible. Firstly, Israel is offered the opportunity to become God's own \emph{treasure.} Secondly, they are to become a \emph{kingdom of priests,} hinting at how Israel is intended to mediate God's blessing to other nations.

Central to Israel's calling is the \emph{Torah} (meaning \emph{teaching}), given to Moses on Mount Sinai and centred upon the Ten \emph{Words} (Commandments). The Torah provides a set of clear, detailed instructions informing Israel how to live in faithful covenant relationship. The Torah thus forms the basis for Israel's vocation: through faithfulness to the covenant, Israel is called to demonstrate love, devotion and allegiance to God. And through covenantal faithfulness, they are to demonstrate God's wisdom and understanding, enabling them to become \emph{a light to the nations}.

Within the covenant relationship, the choices that Israel makes—either faithful covenant relationship or unfaithful idolatry—effectively represent a choice between \emph{life or death}, \emph{blessing or curse}, deliverance or disaster, inheritance or exile. These choices reveal God's kindness \emph{and} severity: kindness towards those embracing his covenant, submitting to his government, available to serve his purposes; severity towards those rejecting his covenant, resisting his purposes, rebelling against his goodness, disobeying his teachings. 
...
\begin{itemize}
\item What is the significance of God's commitment to creation?

\item What are the significant characteristics of God's covenant with Abraham?

\item Why does God need a covenant community?

\item What does God most need from a covenant community?

\item How did King Solomon's failure to faithfully keep God's covenant effect God's purposes?
...
This concludes Study 1, \emph{Covenant and Scripture}, which:

\begin{itemize}
\item Compared Scripture in historical and covenantal perspective

\item Explored the characteristics of covenant and of God's covenants in particular

\item Summarised the unfolding covenant purpose suggested by the patriarchal covenants
...
\begin{figure}[htbp]
\centering
\includegraphics[width=342pt,height=239pt]{EP4light.png}
...
\textbf{Overarching the panorama is the Abrahamic covenant: \emph{a great nation, blessed to be a blessing to all the families of the earth}.}

\emph{God's universal concern for every 'family'—every tribe, language and nation—stretching ahead of Abraham and Israel, forming the foundational framework for the later covenants—including a new, messianic covenant yet-to-come.}
...
\begin{itemize}
\item In the way humans live, how do we variously reflect and contradict God's commitment to creation?

\item To express God's commitment to his creation, what could we consider doing: more often? Less often? For the first time ever? For the last ever time?
...
\item What is the scriptural relationship between King David and the Messiah, Jesus?

\item David was a shepherd, a warrior and a king. Which role most faithfully expressed him as ``a man after God's own heart''?
...
\emph{The LORD [Adonai] says to my Lord [Adon], Sit at my right hand, until I make your enemies your footstool.}\footnote{Matthew 22:41--46; Mark 12:36; Luke 20:42*}
\end{quote}
