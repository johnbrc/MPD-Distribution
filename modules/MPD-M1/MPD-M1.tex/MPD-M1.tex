...
The root meaning of the word, messiah, is \emph{anointed} or \emph{poured on}. Anointing oil was poured onto Israel's kings, as they are invested with their authority.\footnote{Exodus 30:22--25} The anointing represented the placing of God's Spirit upon these leaders.
...
Following this, the Gospels and the apostolic epistles reveal a series of developments in understanding the identity and role of Jesus the Messiah. In particular: as \emph{prophet, king} and, ultimately, \emph{high priest}.\footnote{Also: initially \emph{rabbi}—a recognised religious office, yet with no messianic overtones and thus no threat to Israel's established leadership.} The role of prophets, kings and priests under the terms of the covenant with Israel is highly illuminating in understanding the role of the Messiah. The Old Testament records Israel's prophets, priests and kings holding different, yet complementary roles, each responsible for \emph{mediating} a particular aspect of God's authority.
...
Speaking God's words faithfully, anointing God's leaders and prayerfully interceding for God's people are each a vitally important form of prophetic mediation between God and his covenant community. 
...
\begin{enumerate}
\item The Prophet like Moses (\autoref{theprophetlikemoses}).

\item The Messiah, Branch of David (\autoref{themessiahbranchofdavid})

\item An eternal high priest, seated at God's right hand (\autoref{aneternalhighpriestseatedatgodsrighthand})
...
\item Which type of authority do you personally relate to most vitally?

\end{itemize}

\end{discuss}

\section{The Prophet like Moses}
...
Eventually, Jesus is identified as \emph{the Prophet}—the promised one, who is \emph{like Moses}.\footnote{Deuteronomy 18:15--19, John 1:21, 6:14, 7:40, Acts 3:23, 7:37} Like Moses, Jesus addresses three of the most potent symbols of Israel's faith: Leadership, Temple, Covenant.
...
\section{The Messiah, Branch of David}
\label{themessiahbranchofdavid}
...
\section{An eternal high priest, seated at God's right hand}
\label{aneternalhighpriestseatedatgodsrighthand}

As priest, the Messiah: 
...
These three realities represent the heart of the New Covenant and the consummation of the Messiah's work. The book of \emph{Hebrews} deals with these things in great detail, nevertheless, each idea is originally encountered in the gospels.

\subsection{Purification for sins}
\label{purificationforsins}

John the Baptist identifies Jesus as \emph{the Lamb of God, who takes away the sin of the world}.\footnote{John 1:29; see 1 Corinthians 5:6--8}

\subsection{Seated at God's right hand}
...
Yet, in the traditional framework of Jewish teaching, for a man to identify himself as divine, co-existent with or exalted beside God was considered blasphemous and punishable by death—even though Jesus' demonstrated it was not truly blasphemy.

\subsection{Eternal, heavenly advocate}
...
Thus, Jesus the Messiah enters the true, heavenly tabernacle, in order to offer to Adonai the sacrifice of his life—represented by his blood—and, in so doing, presents again the highly significant juxtaposition of the Messiah sitting down at the right hand of God. In this way, his high priestly ministry within heaven confirms the reality of the \emph{finished} work of his earthly death: the two realities—on earthly and in heaven—acting together to inaugurate the new covenant: \emph{Because of this death{\ldots}he is a mediator of a new covenant.}\footnote{Hebrews 9:15}

In establishing Yeshua as a priest of a different order to Levitical priests, Hebrews introduces, \emph{Malki-Tzedek}, a character found in only two places within the Tanakh.\footnote{From \emph{Malki} (King) of \emph{Tzedek} (Righteousness); \emph{Melchizedek} is also King of \emph{Shalem} (`peace')} \emph{Malki-Tzedek} is the priest of \emph{El 'Elyon}, who received a tithe from the Patriarch, Abraham, and blessed him. Since it was a clearly established principle that ``\emph{the greater blesses the lesser},''\footnote{Hebrews 7:7} the writer of Hebrews performs a \emph{midrash} upon the narrative, establishing Melchizedek as greater than Abraham. 
...
The writer of Hebrews makes a \emph{midrash} upon Melchizedek's lineage in order to draw attention to the reality that the Messiah \emph{became a priest{\ldots}by virtue of the power of an indestructible life}\footnote{Hebrews 7:16}. As a consequence, he has an \emph{eternal intercessory ministry} as advocate for human beings who come to the Father through him:
