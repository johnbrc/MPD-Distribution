...
\def\mycopyright{John B Clements, 2014.  Maize Plant Discipleship by John B Clements is licensed under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. Based on a work at http:/\slash johnbrc.github.io}
...
This module (no. 1) explores \emph{God's Eternal Purpose}, in four studies:
...
The \emph{Maize Plant Discipleship Facilitators Handbook} contains comprehensive guidelines on appropriately facilitating Maize Plant Discipleship learning groups and discussions. It is available from the same source as this handbook or via  \textbf{www.maizeplantdiscipleship.info}.
...
This topic reveals how each \emph{patriarchal} covenant signifies God's unfolding plans and purposes, in collaboration with his covenant community.

\begin{itemize}
\item Each biblical covenant points towards the \emph{restoration} of a creation that has been corrupted by rebellion against God's purposes.

\item Primary to this restoration is the \emph{reconciliation} of human beings, into faithful relationship with their Creator.
...
\emph{Genesis 6:18, 8:6--22, 9:8--16}. God's covenant with Noah begins by reminding Noah that human beings are \emph{made {\ldots} in his image}. It echoes the original creation blessing given to Adam when Noah's family are instructed to \emph{be fruitful and multiply, swarm over the earth and multiply on it}.\footnote{Genesis 1:26--28}
...
\item A sign accompanies this covenant: a rainbow will serve as perpetual reminder of God's covenant promise to never again destroy all living things.
...
\emph{Exodus 6:2--8, 19.4--6, Romans 9:4--9}. A covenant is formed with the nation of Israel, against the backdrop of a powerful deliverance and exodus from the oppression of Egypt's Pharaoh. Abraham's descendants, the \emph{sons of Israel,} acknowledge God as their powerful and faithful Deliver, who has brought them to the point of entering the sanctuary of the land promised to their ancestors.

\begin{itemize}
\item Israel is offered the opportunity to become God's own \emph{treasure} and to become a \emph{kingdom of priests,} hinting at how Israel is intended to mediate God's blessing to other nations.
...
\item Through covenantal faithfulness, they are to demonstrate God's wisdom and understanding, as they become \emph{a light to the nations}.\footnote{Isaiah 42:6}

\end{itemize}

Israel's choice of faithful covenant relationship or unfaithful idolatry, represent a choice between \emph{life or death}, \emph{blessing or curse}, deliverance or disaster, inheritance or exile,\footnote{Deuteronomy 30:1--20} revealing God's kindness and severity:\footnote{Romans 11:22} 

\begin{itemize}
\item kindness towards those embracing his covenant, submitting to his government and available to serve his purposes; 

\item severity towards those rejecting his covenant, resisting his purposes, rebelling against his goodness, disobeying his teachings. 
...
\emph{2 Samuel 7:12--16}.\footnote{Also 1 Chronicles 17:11--14, Psalm 89:19--37} The covenant with Israel called upon them to recognise God as their King. The prophet Samuel thus recognises a deep tragedy unfolding, when Israel demands a mortal king to rule over them. God says to Samuel, \emph{It is not you they are rejecting; they are rejecting me; they don't want me to be king over them}.\footnote{1 Samuel 8:7--8} 

\begin{itemize}
\item To succeed Saul, Israel's first king, Samuel anoints \emph{David}, who is identified as \emph{a man after God's own heart},\footnote{Acts 13:22; cf. 1 Samuel 13:14}. God's covenant with David promises that one of his descendants will build a Temple for God's name and that the royal throne—the reign or government—of David will continue eternally. 

\item Following David's death, rulership passes to his son, Solomon, who begins his reign with great wisdom and overt expressions of covenant faithfulness towards God, including the lavish construction and dedication of the Jerusalem Temple. Yet, though Solomon's reign initially prospers, his many non-Hebrew wives and concubines lead him to worship other gods. 

\item Solomon's idolatry invites God's judgement and results in a national division: into the Northern Kingdom of Israel and the Southern Kingdom of Judah—and, ultimately, exile from the Land. 

\end{itemize}

The covenant promise must be fulfilled by another descendant—a \emph{branch} of David's line:\footnote{Jeremiah 23:5--6} a Redeemer, a King, a Messiah, who would rise in the future to bring deliverance and blessing to Israel.
...
\item What does God most need from his Covenant Community?

\item David was a shepherd, warrior and king. Which role most faithfully expressed him as \emph{a man after God's own heart}?

\end{itemize}

\end{discuss}

\ssection{Summary: Study 1}
...
\item revealed how each patriarchal covenant signified God's unfolding plans and purposes
...
\item If we want to reflect God's commitment to creation, what might we consider doing: More often? Less often? For the first time? For the last time?
