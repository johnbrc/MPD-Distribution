...
The New Testament Gospels provide historical accounts of Jesus' life, work, signs, miracles, teaching, discipleship and, finally, death, resurrection and ascension. Matthew, Mark, Luke and John write not as impartial observers or secular historians. They write as committed members of an emerging \emph{new covenant community}. Their intent is to establish Jesus' true identity, significance and purpose as the Jewish Messiah.\footnote{John 20:31} 

They achieve this by drawing upon a wide range of biblical imagery, hints, stories, signs, events, parables and metaphors and, above all, prophecies, which are deeply rooted in Israel's Patriarchal, covenant framework. They use these biblical signposts and illustrations to confirm and illuminate precisely how Jesus fulfils the ancient, covenant promises and biblical prophecies. In doing so, they strongly affirm that Jesus is the promised One: the Messiah and the guarantor of a new covenant with the house of Israel and Judah*.\footnote{Hebrews 7:22, 8:6--13}
...
\midrule
Psalm 2.7; 2 Samuel 7.12--16 (Proverbs 30.4)&\textbf{the Son of God}&Matthew 3.17; Luke 1.32\\
...
The figure below, \emph{Messiah and New Covenant}, updates the biblical, historical timeline being constructed by this study, illustrating how: 
...
The root meaning of the word, messiah, is \emph{anointed} or \emph{poured on}, referring to the anointing oil poured onto Israel's kings and priests. The anointing oil symbolises the pouring out or placing of God's Spirit upon a leader, as they are invested with their authority.\footnote{E.g. Exodus 30:22--25} 

A full understanding of the biblical concept of \emph{the Messiah} requires appreciating the roles of prophet, king and priest. Emphasising these three roles provides a fresh, biblical route to understanding Jesus.\footnote{Compared with traditional Christian emphases that tend to focus directly upon the doctrine of Jesus' eternal divinity. This is not to create controversy, not to deny or challenge traditional Christian doctrines. It is to allow us to perceive Jesus the Messiah from the scriptural perspective of first-century Jews, to whom he appeared in the flesh.}

As we read the whole of the New Testament, starting with the Gospels, continuing through the apostolic epistles and the expository book of \emph{Hebrews}, in particular, it becomes clear that Jesus was principally understood by his first-century Jewish disciples as: 

\begin{itemize}
\item Rabbi — a teacher of Torah

\item Prophet — including \emph{the Prophet}

\item Messiah — \emph{Son of David}, \emph{Son of God}

\item High Priest — of \emph{the order of Melchizedek}

\end{itemize}

In this way, the biblical understanding of the Messiah's identity and vocation transitioned from being recognised amongst his native Jewish people, as learned rabbi and divinely-anointed prophet, to transcendent, divine human being, seated at the Right Hand of the Power on High (The Eternal One, God the Father), granted complete authority in heaven and on earth, so as to be a perfect \emph{Mediator} on behalf of people from every ethnicity, tribe, language and nation.

\subsection{Messiah : Jewish prophet : ``Son of Man''}
\label{messiah:jewishprophet:sonofman}

Within the gospels, \emph{prophet} is the only role with which Jesus is popularly identified. As prophet, in the Jewish tradition of prophets such as Moses, Elijah and Jeremiah, Jesus' primary purpose was to announce the immanent arrival of \emph{the kingdom of God}.\footnote{Mark 1:14--15}

\begin{itemize}
\item A significant element of this prophetic announcement and enactment of the government or reign of God was Jesus' critique of the incumbent religious leadership of Israel: a combination of the sects of Pharisees and Sadducees. These leaders were held responsible for the ongoing corruption of the covenant relationship: publicly going through the motions of Torah-obedience, yet with \emph{uncircumcised hearts}. 

\item Jesus cursed them\footnote{\emph{Woe to you{\ldots}} was a form of curse, see also (fig tree)} for neglecting the greater commandments of humility, mercy and justice, making covenant faithfulness harder for others, whilst occupying \emph{the seat of Moses},\footnote{Matthew 23:1--39} which represented the position of priestly and prophetic leadership.\footnote{Jesus completely denounced these groups, yet even amongst them there were individuals who were \emph{close to the kingdom}, some of whom became his disciples—Mark 12:28--34}

\end{itemize}

As a prophet, Jesus called the \emph{lost sheep of the house of Israel} to repentance:\footnote{Matthew 10:6, 15:24} to a renewed covenant faithfulness. Ultimately, it became clear that this renewal required a radical change, to a new way of life, within an emerging, New Covenant Community, centred around him, as Israel's new King.

\subsection{Messiah : King of the Jews : ``Son of God, Son of David''}
\label{messiah:kingofthejews:sonofgodsonofdavid}

Messiah, in the context of first-century Judaism, essential meant \emph{king}— king of the Jews.\footnote{Luke 22:66--71 to 23:2}

\begin{itemize}
\item The messianic king, Jesus identified himself as the Branch and Ruler promised via the Davidic covenant, the \emph{One Shepherd,} whom God was using to bring about his eternal purpose, through Israel, on behalf of all the nations of the earth. 

\item As Shepherd-King, he issues an invitation, a call to all those who will \emph{hear his voice}:\footnote{John 10:3--4,16,27} \emph{Turn towards God; trust in me, follow and give your allegiance to me, submit to me as your Messiah, your Lord}.\footnote{Matthew 23:10} In so doing, he inaugurates within those that accept, follow and give allegiance to him a new, Messianic Covenant Community, spiritually centred around himself as the exalted Lord—their Messiah, their King.

\end{itemize}

Being the Messiah meant being the ruler \emph{appointed and anointed} by God to govern his covenant community. This is why Jesus represented a threat to the Torah-teachers and the Pharisees, who eventually plotted to kill him.

\subsubsection{Understanding biblical references}
\label{understandingbiblicalreferences}

The titles, \emph{Son of David},\footnote{Matthew 1:1 etc.} and \emph{Son of God}\footnote{Within first-century Judaism, \emph{Son of God} did not represent divinity, being simply used to refer to a godly person in general or the \emph{special one,} the Messiah, sent by God, in particular. [REF Stern]

This is a significant contrast to the Christian tradition, whereby \emph{Son of God} is typically understood as a direct reference to Jesus' divinity, as a member of the ``Trinity'' of Father, Son and Holy Spirit. 

In fact, the idea of a \emph{divine} messiah is, at best, hinted at within the gospel narratives, but is practically never the central idea. 

\begin{itemize}
\item Hence, for example, Luke ending his gospel (ch.24:44--48) with Jesus encouraging his disciples to be witnesses, \emph{not of his divinity}, but rather that: \emph{Everything written about me in the Torah, the Prophets and the Psalms had to be fulfilled: the Messiah is to suffer and to rise from the dead on the third day. You are witnesses of these things.}

\end{itemize}

\begin{itemize}
\item See also the passage Luke 22:66--71 to 23:2, which identifies

\end{itemize}

Approximately fifty years after his death, Jesus' divine status was more overtly communicated within John's gospel, not least in its opening announcement: ``\emph{the Word was with God {\ldots} the Word was God}.'' By this time many of Paul's epistles had been distributed, containing his groundbreaking expositions of \emph{mysteries now revealed} and announcements of the Messiah's divine glory and universal significance, allowing Jesus' divinity and incarnation and their extraordinary implications to dawn more fully within the New Covenant community.} are the most significant in identifying the Messiah.

\footnote{Matthew 16:16 and 26:63, where the two titles, \emph{Son of God} and \emph{Messiah} are used synonymously.}

At the onset of his public ministry, as he begins to gather disciples around him, Jesus is highly reluctant to reveal his identity as the Messiah. He frequently instructs people not to spread this news. Later, it becomes highly significant.\footnote{Matthew 16:16; see also John 1:49; Luke 22:66--70; John 11:27}
