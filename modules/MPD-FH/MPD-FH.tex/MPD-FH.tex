\def\version{0.3.4 --- Copyediting Draft}
\def\change{Final tinkering}
\input{mpd-header}
...
Yes. Maize Plant Discipleship is principally a learning, not a teaching resource. Facilitating Maize Plant Discipleship provides a profound \emph{opportunity}, yet the decision to learn always rests with the student and depends upon many things, including desire, temperament, experience, opportunity, talent, time, energy, environment and so forth.
