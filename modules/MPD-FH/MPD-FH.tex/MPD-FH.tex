\def\version{0.3.1 --- Copyediting Draft}
...
Fostering an environment of learning and discovery, where debate and discussion is lively, yet relaxed and uncompetitive is essential. An ideal environment will allow strong and diverse views to be expressed, without creating conflict or conformity, so all present are comfortable to contribute views, questions and burdens. 
...
With appropriate adaption, Maize Plant Discipleship studies can be used for congregational teaching. For example, the congregation, after receiving a teaching study, could divide into small discussion groups. Alternatively, learning groups could meet on a separate occasion, to reflect upon and discuss the teaching and to pray together.
...
Important definitions provided below explain how these significant terms are used in the The Maize Plant Discipleship Syllabus (\autoref{themaizeplantdiscipleshipsyllabus}).

\subsection{Messiah}
\label{messiah}

Messiah means \emph{anointed} or \emph{poured on,} referring to the anointing oil poured onto Israel's kings and priests, as they were invested with their authority, typically by prophets (Exodus 30:22--25). The anointing oil represents a metaphor for the placing of God's Spirit upon a leader. Thus the idea of God's priestly, kingly and prophetic authority is inherent in the concept of Messiah. The concept is broadly equivalent to the idea of a \emph{Deliverer}: one who delivers a people from the hands of their enemies. In the biblical history of Israel, deliverance came through a variety of \emph{types} of messiah, including priests, prophets, judges and kings.

\begin{description}

\item[The New Testament identifies Jesus as the Jewish Messiah]

Fulfilling three mediatory roles of prophet, king and priest and becoming \emph{the One Unique Mediator between God and human beings}\footnote{1 Timothy 2:3--6}. \emph{Christ} is the Greek translation of the Hebrew word \emph{Moshiach} (Messiah). Thus, Jesus Christ is the Greek rendering of \emph{Yeshua Moshiach}.\footnote{Module 1 of the Maize Plant Discipleship Syllabus includes a biblical exploration of the concept of Messiah and its fulfilment.}
\end{description}

\subsection{Messianic}
\label{messianic}

Messianic means ``of or relating to the Messiah.'' It is primarily used in the Syllabus to refer to:

\begin{description}

\item[Messianic Community (capitalised)]

Referring to the whole, worldwide and historical body of people belonging to the Messiah. In the New Testament this community is referred to as \emph{the body of Christ \slash  the Messiah}. The reference is broadly equivalent to \emph{worldwide Christian community,} or \emph{Church.} Those terms are avoided because of their association with particular historical expressions of Christianity that are not inclusive.

\item[messianic communities (un-capitalised)]

Referring to localised congregations of the Messianic Community. The term is used in preference to ``churches'' in order to emphasise the biblical link to the whole body of the Messiah, the Messianic Community.
\end{description}
...
Calling, life's work, mission, purpose, function; profession, occupation, career, job, employment, trade, craft, business, line, line of work, métier.
\end{description}

\emph{Vocation} and \emph{vocational} refer to both personal and communal calling. Within the Syllabus, the terms are used to emphasise that individual and local community' sense of vocation and calling flows from the divine calling to serve God's eternal purpose, through following the Messiah.

Vocation also represents an umbrella term that incorporates and dignifies all forms of work and ministry. It looks beyond the traditional divides of laity and clergy, pointing towards the reality that all followers of the Messiah are \emph{called} to faithfully serve God's purposes, within homes, workplaces and communities. 
...
Tite Tienou, a Malian who grew up in Burkina Faso, encapsulates, below, a highly significant aspect of the philosophy that has driven the development of Maize Plant Discipleship: \emph{African voices need to determine the theology that is of practical relevance to African contexts}. 
...
Although Maize Plant Discipleship is authored by an outsider to Africa, it could and would not have developed without the critical input, missional energy, encouragement, friendship and culture of African people, at each stage of its formation, as it has been:
...
\item formulated in direct response to contextual doctoral research carried out amongst Burkinabé leaders and learners.
...
Between 2009--13, doctoral research was carried out,\footnote{http:/\slash maizeplantdiscipleship.info\slash research} incorporating a qualitative consultation of Burkinabé leaders and learners, using survey questionnaires, focus groups and personal interviews that took place following prototypical Maize Plant Discipleship seminars delivered to conferences in Léo and Ouagadougou. The research:
...
Participants strongly expressed a desire for \emph{appropriate literature}. In Burkina, as in Africa and the Majority World generally, leaders and learners typically mediate between two cultural worlds of orality and literacy respectively. Accordingly Maize Plant Discipleship handbooks are: 
...
\item Intended to be translatable into mother-tongue languages.\footnote{To discuss translating Maize Plant Discipleship resources, for printing and distribution in another language, visit http:/\slash maizeplantdiscipleship.info}
...
\emph{If you send then to us, we may be able to incorporate them into future editions. However{\ldots}}
