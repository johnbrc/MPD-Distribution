\def\version{0.3.12 --- Copyediting Draft}
\def\change{minor ammendments}
\input{mpd-header}
...
Maize Plant Discipleship by John Clements is licensed under a \textbf{Creative Commons Attribution-ShareAlike 4.0 International License}. Based on a work at http:/\slash johnbrc.github.io\slash MPD-Distribution\slash . Permissions beyond the scope of this licence may be available at www.maizeplantdiscipleship.info
