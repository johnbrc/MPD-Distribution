\def\version{0.3.3 --- Copyediting Draft}
\def\change{Reordered chapters, question boxes
Rearranged pause boxes, ch 5}
\input{mpd-header}
...
When we share our lives, we learn together and \emph{learning groups} mirror this reality. Together, we experience and learn quite differently to when we study alone. Reflective discussion with others, in particular, provides a highly stimulating forum for learning through exploration, listening and discovery. \emph{See Maize Plant Discipleship Learning Process for further discussion}.

\subsection{Learning, not teaching?}
\label{learningnotteaching}

Yes. Maize Plant Discipleship is principally a learning, not a teaching resource. Facilitating Maize Plant Discipleship provides a profound \emph{opportunity} for learning, yet the decision to learn always rests with the student and depends upon many things, including desire, temperament, experience, opportunity, talent, time, energy, environment and so forth.
...
Discipleship can never be reduced to a mere replication of information, from teacher or textbooks into students. We may have been taught this way in school; Spirit-led discipleship is different. It \emph{forms}, as well as informs.
...
consider experimenting with changes of location; perhaps even meeting outside sometimes.
\end{description}
...
\emph{anointed} or \emph{poured on,} referring to the anointing oil poured onto Israel's kings and priests, as they were invested with their authority, typically by prophets (e.g. Exodus 30:22--25). The anointing oil represents the pouring out, or placing of God's Spirit upon a leader. 

The concept essentially refers to a mediator or saviour, acting with God's authority, to deliver a people from the hands of their enemies. In the biblical history of Israel, deliverance came through a variety of mediators such as prophets, priests, judges and kings. Thus the idea of God's priestly, kingly and prophetic authority is inherent in the concept of Messiah. 

The New Testament identifies Jesus as the Jewish Messiah—\emph{the one Mediator between God and humanity}\footnote{1 Timothy 2:5}—who was anointed by the Spirit to mediate on behalf of God's people and the nations—see Matthew 3:13--17; Mark 1:9--11; Luke 3:21--22 \& 4:16--19; John 1:32--34—by fulfilling all three mediatory roles of prophet, priest and king. (\emph{Christ} is the Greek translation of the Hebrew word \emph{Moshiach} (Messiah). Jesus Christ is the Greek rendering of \emph{Yeshua Moshiach}.)

\item[Messianic —]

\emph{of or relating to the Messiah}; primarily used in the syllabus to refer to Messianic Community.

\item[Messianic Community —]

(capitalised) referring to the whole, worldwide and historical body of people belonging to the Messiah. In the New Testament this community is referred to as \emph{the body of Christ, or Messiah}. The reference is broadly equivalent to \emph{worldwide Christian community,} or \emph{Church.} Those terms are avoided because of their association with particular historical expressions of Christianity that are not inclusive.

\item[messianic communities —]

(un-capitalised) referring to localised congregations of the Messianic Community. The term is used in preference to \emph{churches} in order to emphasise the biblical link to the whole body of the Messiah, the Messianic Community.
...
Vocation and \emph{vocational} may refer to both personal and communal calling. Within the syllabus, the terms are used to emphasise that both an individual and a local community's sense of vocation flow from the divine calling to serve God's eternal purpose, through following the Messiah.
...
\item[Are you African?]

Or working in African contexts? Can you think of stories, proverbs and examples that illustrate and express the principles contained in any of the Maize Plant Discipleship handbooks, in a way that is especially suited to your local context?

\emph{If you send your ideas to us, we may be able to incorporate them into future editions. However{\ldots}}

\item[Are you aware —]

that the Creative Commons licence permits you to rewrite parts of the Maize Plant Discipleship Syllabus and republish it? 

All that is required is that you follow the terms of the licence precisely, including \emph{attribution} and \emph{sharing-alike}, so that others can access and use the material.
\end{description}
...
Maize Plant Discipleship by John Clements is licensed under a \emph{Creative Commons Attribution-ShareAlike 4.0 International License}. Based on a work at http:/\slash maizeplantdiscipleship.info. Permissions beyond the scope of this licence may be available at http:/\slash maizeplantdiscipleship.info\slash contact. 

\begin{quote}

\textbf{Note}: What follows is a simplified summary of (and not a substitute for) the licence, which may be accessed at: http:/\slash creativecommons.org\slash licenses\slash by-sa\slash 4.0\slash legalcode
\end{quote}
