\def\version{0.4.0 --- Pre-publication draft}
\def\change{Incorporating copyediting changes @artapin}
\input{mpd-header}
...
\begin{itemize}
\item HEAR—hearing about others' experiences and perspectives; practice informing theory and theory informing practice. 

\item REFLECT—reflecting upon the interaction of old and new ideas, concepts and perspectives. 

\item DISCUSS—testing understanding and sharpening conviction in conversation with others.

\item ACT—integrating learning into praxis, within vocational contexts.
...
\subsection{1. HEAR {\ldots} what the Spirit is saying}
...
\subsection{2. RETAIN {\ldots} God's message inwardly}
...
\subsection{3. OPEN {\ldots} our hearts to others' perspectives}
\label{openourheartstoothersperspectives}
...
\subsection{4. SHARE {\ldots} our daily bread}
...
\subsection{5. PRAY {\ldots} for God's kingdom to come}
...
\subsection{6. ACT {\ldots} in the light of God's message}
...
Each syllabus module is incorporated in a Maize Plant Discipleship \emph{Handbook}, which contains four interrelated \emph{Studies}, each of which incorporates:
...
passing a single handbook around a group is not recommended. Instead, diagrams and illustrations should be reproduced, using blackboards or other aids, even drawing on the ground if necessary, in order to allow all group members to appreciate the relevance of the topical illustration. \emph{If you have an artist in the group, try giving them this task}.
\end{description}
...
means \emph{anointed} or \emph{poured on,} referring to the anointing oil poured onto Israel's kings and priests, as they were invested with their authority, typically by prophets (e.g. Exodus 30:22--25). The anointing oil represents the pouring out, or placing of God's Spirit upon a leader. Thus the idea of God's priestly, kingly and prophetic authority is inherent in the concept of Messiah. Speaking broadly, it means a mediator or deliverer: one who delivers a people from the hands of their enemies. In the biblical history of Israel, deliverance came through a variety of mediators, such as priests, prophets, judges and kings.

The New Testament identifies Jesus as the Jewish Messiah—\emph{the one Mediator between God and humanity}\footnote{1 Timothy 2:5}—who fulfilled three mediatory roles of prophet, king and priest. \emph{Christ} is the Greek translation of the Hebrew word \emph{Moshiach} (Messiah). Thus, Jesus Christ is the Greek rendering of \emph{Yeshua Moshiach}.\footnote{Module 1 of the Maize Plant Discipleship Syllabus includes a biblical exploration of the concept of Messiah and its fulfilment.}

\item[Messianic —]

means \emph{of or relating to the Messiah.} It is primarily used in the syllabus to refer to Messianic Community.
