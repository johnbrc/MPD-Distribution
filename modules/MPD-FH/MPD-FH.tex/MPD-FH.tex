...
\item[Vocation is more than simply our employment —]
...
\item[Consider traditional proverbs —]

in relation to study topics. The \emph{sweet talk} of proverbs can provide fresh insight and be helpful in discussing Maize Plant Discipleship with others, such as elders or non-believers.
\end{description}
...
\item[A learning cycle is simply a tool —]
...
It is a body learning to walk in the footsteps of Jesus: learning to exercise its God-appointed, mediatory, intercessory, messianic role, under the direction of the Spirit of God.\footnote{Romans 6:3--4; Galatians 3:26--29; Hebrews 6:4}
...
Maize Plant Discipleship by John Clements is licensed under a \textbf{Creative Commons Attribution-ShareAlike 4.0 International License}. Based on a work at http:/\slash johnbrc.github.io\slash MPD-Distribution\slash 
