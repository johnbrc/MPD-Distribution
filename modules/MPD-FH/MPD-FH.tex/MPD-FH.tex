\def\version{0.2.6 --- Post Review Draft}
\def\change{chaps 1-4 complete
...
Maize Plant Discipleship is ideal for learning groups of 8--10 people. This is small enough to grow together with a degree of intimacy; large enough for group members to explore discipleship commitments at their own pace.
...
Replication is an important goal of Maize Plant Discipleship. It may not be necessary for a group member to complete the entire syllabus before facilitating another learning group—see the Maize Plant Philosophy of Discipleship (\autoref{maizeplantphilosophyofdiscipleship}) for encouragement about the importance of replication.
...
The entire Maize Plant Discipleship syllabus incorporates approximately 64 studies. When considering a timetable take into consideration the nature of the group availability. \emph{For example, are members effected by the agricultural or academic calendar?}
...
Incorporate reflective learning methods by submitting the fruit of personal study to the oversight of a mentor, or sharing it with a fellow student, for reflection, discussion and critical consideration.
...
With appropriate adaption, Maize Plant Discipleship studies can be used for congregational teaching. For example, if teaching were delivered to the whole congregation, it could then divide into discussion groups. Alternatively, small learning groups could meet on another occasion, to reflect upon and discuss the teaching and pray together.
...
Illustrations are provided throughout the Maize Plant Discipleship handbooks. Where possible, reproduce diagrams on blackboards or in other ways that allow all group members to see and understand their relevance to the topic.

\section{Scripture versions}
\label{scriptureversions}

Throughout the MPD Syllabus Handbooks, scripture references, rather than quotations, are provided. Where a quotation is incorporated within the teaching, the following abbreviations indicate the version from which the quote is taken:
...
thus, mother-tongue Scripture translations may be encouraged and utilised as much as possible, including during discussions and particularly for reading and memorisation.
\end{description}
...
Maize Plant Discipleship approaches messianic discipleship as a dynamic, generational process, empowered by the Holy Spirit. Two crucial statements made by the apostle, Paul, in his second letter to his disciple, Timothy, help to fully illustrate what is involved in this process:\footnote{The two statements are separated only by Paul's emotional description of two disciples who failed to stand with him at a crucial time.}
...
Together they reveal three key components of messianic discipleship.
...
The Holy Spirit provides an intimate source of divine help to messianic disciples.\footnote{John 16:7--15} It is he who mediates the reality of the Gospel and the Presence of the Messiah amongst his people and it is he who helps them to safeguard this reality.

\item \textbf{The necessity of generational formation}.

Timothy has received an impartation of the reality of the Messiah through Paul, something of great worth that he must now safeguard by \emph{committing it to the stewardship and safekeeping of other faithful people}. This is generational discipleship. 
...
Generational discipleship is how, in the kingdom of God, treasure is kept safe, from becoming unproductive.\footnote{Matthew 25:14--30} The importance of this principle can be understood by examining the importance of seeds.

\subsection{Seed and harvest}
\label{seedandharvest}

In farming contexts, seeds are a form of wealth—a type of treasure. Yet seed is generally stored only for a short time before being used. Whatever is not required for food, \emph{for daily bread}, must soon be sown to produce another harvest.\footnote{2 Corinthians 9:6--12}
...
This is one of the secrets to living a truly \emph{messianic} life, which many people seem never to properly discover or experience: it is not in hoarding the treasure of our knowledge, relationship and communion with God, but in sharing it with others, both within and beyond our own communities, that we discover and realise our vocation.\footnote{Matthew 10:38--39}

Spiritual treasure, however, should never be wasted or cast away carelessly. Although some seeds inevitably fall onto unreceptive ground,\footnote{Matthew 13:1--23} a farmer never intentionally wastes his seed. Likewise, our treasure is too precious to be deliberately squandered on people who spurn its value.\footnote{Matthew 7:6} It must be shared with people who recognise its worth and who make room for its transformative power to change them.
...
This dynamic movement spreads geographically and, significantly, across ethnic and cultural boundaries. From its beginnings in Jerusalem, the movement expands throughout Palestine, Asia Minor, Greece and finally to Rome—the current centre and seat of worldly power.
...
Thus, any messianic movement or community, whether national, regional or local, that earnestly desires spiritual revival or renewal must place visionary, messianic discipleship at the core of its spirituality and its practical formation.
...
from \emph{charism}, Greek, meaning \emph{gift}; the \emph{charisma} of the Christian community comes from its spiritual anointing

\item[Messiah]

essentially means \emph{Anointed One}; the One Anointed with the Spirit to rule God's people (Matthew 3:13--17; Mark 1:9--11; Luke 3:21--22; John 1:32--34)
\end{description}
...
\begin{discuss}[Questions for reflection and discussion]
...
Although Maize Plant Discipleship is authored by an outsider to Africa, it could and would not have developed without the missional energy, friendship, hospitality, encouragement and input—the \emph{umunthu}—of African people, at each stage of its formation. It has been

\begin{itemize}
\item authored exclusively in response to requests from African leaders and learners;

\item road-tested in collaboration with African leaders and learners, throughout its development;

\item formulated in response to contextual doctoral research carried out in Burkina Faso, with translation into African languages a primary goal.
...
describes Abraham as a man whose faith \emph{called into being things that did not exist}. In a similar way, Maize Plant Discipleship has been \emph{called into being} by the trusting faithfulness of Africans, acting in response to the needs of African contexts.
\end{description}
...
Maize Plant Discipleship was trialled and developed during a series of visits to Burkina Faso, between 2003--08. Following this, doctoral research carried out between 2009--13,\footnote{With \emph{Fuller School of Intercultural Studies}—see http:/\slash maizeplantdiscipleship.info\slash research} enabled an in-depth consultation of Burkinabé leaders and learners on a wide range of concerns and questions relating to contextually appropriate biblical and practical discipleship and leadership training resources. 

\begin{itemize}
\item Research data (reflective opinions, perspectives, information and insight) was collected via survey questionnaires, group and personal interviews, following prototypical Maize Plant Discipleship seminars delivered to conferences in Léo and Ouagadougou.
...
were consulted, drawn from members of the \emph{Assemblée Evangélique de Pentecôte, Assemblée de Deus, Association Nationale pour la Traduction de la Bible et de l'Alphabetisation, Mouvement des Jeunes Serviteurs de Dieu} and \emph{SIL}. This included a significant proportion of national, regional and denominational leaders, many of whom were responsible for leadership training and development.
\end{description}
...
Applying qualitative data-analysis to the collected data revealed a number of significant \emph{findings}, or themes, relating to issues of discipleship, leadership training, theology, culture, intercultural relations and literacy. 

In particular, participants:

\begin{itemize}
\item identified strongly with the concept of discipleship and a need to freshly embrace holistic, disciple-forming practices;

\item consistently validated the missiological content (see below) of a prototypical training resource as appropriate to Burkinabé contexts, highlighting its biblical content, practical focus and cultural sensitivity;

\item affirmed the importance of including graphical and analogical illustrations and allotting time for reflection and discussion;
...
These analytical conclusions were used to define a set of \emph{practical, relevant and accessible} attributes that could be applied to the formulation of training resources appropriate to Burkinabé leaders and learners.

\subsection{Practical}
\label{practical}

Providing a focus upon intentional action
...
Embodying qualities and characteristics appropriate to contextual culture
...
\item Facilitating reflective learning and group discussion. 
...
Lowering or removing barriers that hinder access to the curriculum
...
\item Licensing republication and redistribution.

\item Distribution favouring the economically poorest.
...
The research recommended a biblically faithful missiology, integrated with Pentecostal spirituality and appropriate to African contexts would incorporate:
...
After you have examined and used Maize Plant Discipleship resources, if you believe we can improve upon these attributes, or their application, please contact us with your ideas.
...
Books imported into Africa for theological education have typically been written for Christians in western cultural contexts and translated as an afterthought. Accordingly, they are concerned with a quite different set of questions, cultural values and missiological convictions to those concerning African communities. In short, many textbooks used in African leadership training are contextually inappropriate.

Added to this, books are published and distributed in a manner designed to protect the commercial interests of authors, publishers, distributers and retailers. Thus, many books are practically unattainable to those who are economically poor—including many leaders hungry for resources to enrich their vocational work of forming Christian disciples.

\section{What kind of books are needed?}
\label{whatkindofbooksareneeded}

Doctoral research, carried out in Burkina Faso, in 2010, identified a series of practical, relevant and accessible characteristics applicable to textbooks intended to be appropriate for pastoral and missional leaders and learners in Burkina Faso.\footnote{See Chapter 4, Africa and Maize Plant Discipleship, Doctoral Research (\autoref{doctoralresearch}).}

One of the research's key findings was that many leaders in Burkina—and in Africa and the Majority World, in general—typically mediate between the two cultural worlds of orality and literacy respectively. Accordingly they need textbooks that: 

\begin{enumerate}
\item facilitate, rather than hinder, mediation between these two `worlds';

\item are readily translatable into mother-tongue languages;

\item can be republished in a low-cost way, which energises mission and encourages rapid multiplication.

\end{enumerate}

\begin {pause}

A Burkinabé theological educator, on examining the concept of Maize Plant Discipleship and a prototype booklet, said:

\begin{quote}

\emph{I think you are touching something that is not already existing. If we talk about evangelism, it may well be a new way of approaching evangelism, but we already have many methods of evangelism. But (a series of books on) discipleship is something that is really an innovative thing.}
\end{quote}
...
Accordingly, Maize Plant Discipleship resources are being licensed for reproduction under the terms of a \emph{Creative Commons} licence (\autoref{licence}), which 

\begin{itemize}
\item allows MPD resources to be republished, translated, distributed and sold. 

\item respects and maintains the copyright of the author and translators, whilst releasing the traditionally tight, commercial control of copyright owners and publishers.
...
The text books of the Maize Plant Discipleship Curriculum have been intentionally formulated to be readily translatable. If you would like to discuss translating MPD resources, for printing and distribution in another language, please get in touch.
...
printed double-sided, on A4 paper, folded, stapled and trimmed to produce A5 booklets, with a single-colour printed cover, can be produced for approximately \$2.

\item[For some missional leaders]

this cost may still be too high. An agency organising republication, on behalf of a number of other organisations, may be the most appropriate way to economise on cost. A creative economic model could then subsidise costs for some individuals and, or groups.
\end{description}
