...
\def\change{figures; ch5; ch4-discipleship movements}
\input{mpd-header}
...
\begin{itemize}
\item Scripture references, within in the footnotes, provide a rich treasury of additional material for in-depth biblical study
...
\item \textbf{RETAIN} {\ldots} God's message inwards

\item \textbf{OPEN} {\ldots} heart to other perspectives
...
\subsection{Loss of momentum}
\label{lossofmomentum}
