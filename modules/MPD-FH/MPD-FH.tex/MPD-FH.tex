\def\version{0.3.2 --- Copyediting Draft}
\def\change{Learning process -$>$ chapter
Various headings adjusted
Questions moved to pause boxes}
\input{mpd-header}
...
Whomever is presenting a topical study should read through it carefully, in advance: absorbing, familiarising and reflecting upon the teaching and its lessons. If anything is unfamiliar or unclear, invite discussion about that area of the study, encouraging group members to bring forward their perspectives.

\subsection{Replication}
\label{replication}

Replication is an important goal of Maize Plant Discipleship. see the Maize Plant Philosophy of Discipleship (\autoref{maizeplantphilosophyofdiscipleship}) for encouragement about its importance. It may not be necessary for a group member to complete the entire syllabus before branching out to facilitate another learning group. Be led by the Spirit.
...
to create intimate, yet practical spaces, whereby everyone can see each other during discussions.
...
might aspects of the Maize Plant Discipleship Learning Cycle be adapted and incorporated into personal study, theological education or congregational life?
\end{description}
...
The New Testament identifies Jesus as the Jewish Messiah—\emph{the one Mediator between God and humanity}\footnote{1 Timothy 2:5}—who fulfilled all three mediatory roles of prophet, priest and king. \emph{Christ} is the Greek translation of the Hebrew word \emph{Moshiach} (Messiah). Thus, Jesus Christ is the Greek rendering of \emph{Yeshua Moshiach}.\footnote{See Module 1 of the Syllabus for an exploration of the biblical fulfilment of the Messiah.}
...
\item[\textbf{The book of Acts provides a powerful illustration} —]

of the dynamic growth of a messianic, discipling movement. Examine the context of these verses, in your own Bibles, to see how this growth takes place.
\end{description}
...
essentially means \emph{Anointed Deliver}; the One anointed with the Spirit to rule over and mediate on behalf of God's people—see Matthew 3:13--17; Mark 1:9--11; Luke 3:21--22; John 1:32--34.
\end{description}
...
Tite Tienou, a Malian who grew up in Burkina Faso, encapsulates a highly significant aspect of the philosophy that has guided the development of Maize Plant Discipleship: it should be African voices that determine the theology that is of practical relevance to African contexts. He writes:
...
Finally, it has been formulated in response to contextual doctoral research carried out amongst Burkinabé leaders and learners.
...
The author carried out doctoral research,\footnote{www.maizeplantdiscipleship.wordpress.com\slash research} between 2009 and 2013, which consisted of a qualitative consultation of Burkinabé leaders and learners. Following Maize Plant Discipleship seminars, delivered to conferences in Léo and Ouagadougou, a series of survey questionnaires, focus groups and personal interviews:
...
\item Intended to be translatable into mother-tongue languages:\footnote{To discuss translating Maize Plant Discipleship resources, for printing and distribution in another language, visit www.maizeplantdiscipleship.info}
...
This included members of \emph{Assemblée Evangélique de Pentecôte}, \emph{Mouvement des Jeunes Serviteurs de Dieu}, \emph{Association Nationale pour la Traduction de la Bible et de l'Alphabétisation}, \emph{Assemblée de Deus} and \emph{SIL}.
\end{description}
...
\item If they are not covered by this syllabus, what might you do?
