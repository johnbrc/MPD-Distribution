\def\version{0.3.9 --- Copyediting Draft}
\def\change{(revised: figures; ch5)}
\input{mpd-header}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=163pt,height=250pt]{mpd-metaphor.png}
\caption{}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=284pt,height=384pt]{mpd-dynamics.png}
\caption{}
\label{mpd-dynamics.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=303pt,height=393pt]{mpd-disciplines.png}
\caption{}
\label{mpd-disciplines.png}
\end{figure}
...
that could help to illustrate and illuminate the teaching contained in the Maize Plant Discipleship syllabus, in a way that is especially suited to a particular cultural context?

\emph{If you send me your ideas, I may incorporate them into future editions. Alternatively, under the terms of the Maize Plant Discipleship Licence, you could consider including them in your own republication.}

\emph{The Creative Commons Licence, reproduced at the end of each handbook, permits republication and adaption, such as translation or inclusion of contextualised elements.}
\end{description}
