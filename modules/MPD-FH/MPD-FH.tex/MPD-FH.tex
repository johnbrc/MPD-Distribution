\def\version{0.2.7 --- Post Review Draft}
\def\change{nearing completion
...
\item formulated in response to contextual doctoral research carried out in Burkina Faso.
...
contributed research data, including members of the \emph{Assemblée Evangélique de Pentecôte, Mouvement des Jeunes Serviteurs de Dieu, Association Nationale pour la Traduction de la Bible et de l'Alphabetisation, Assemblée de Deus} and \emph{SIL}. A significant proportion were national, regional and denominational leaders, with responsibility for leadership training and development.
\end{description}
...
Doctoral research, carried out in Burkina Faso, in 2010,\footnote{See Chapter 4, Africa and Maize Plant Discipleship, Doctoral Research (\autoref{doctoralresearch}).} identified a series of practical, relevant and accessible characteristics applicable to textbooks intended to be appropriate for pastoral and missional leaders and learners in Burkina Faso.

One of the research's key findings was that many leaders in Burkina—as is true in Africa and the Majority World, in general—typically \emph{mediate} between the two cultural worlds of orality and literacy respectively. Accordingly they need textbooks that: 
...
\emph{Maize Plant Discipleship} has been formulated and is being published in a manner designed to meet the specific contextual needs that are listed above, with the aim of fostering and facilitating a widespread adoption of discipleship praxis amongst African leaders and learners.

\subsection{Facilitating mediation between orality and literacy}
\label{facilitatingmediationbetweenoralityandliteracy}

\begin{itemize}
\item Central focus on practical discipleship, worked out in relationship with a local group of co-learners{\ldots}

\item amongst which scripture memorisation, reflection and discussion are key components of group learning dynamics of{\ldots}

\item a modular syllabus, incorporating metaphorical and graphical illustrations.

\end{itemize}

\subsection{Intentionally formulated to be readily translatable}
\label{intentionallyformulatedtobereadilytranslatable}

\begin{itemize}
\item Thematic structure of modules, studies, topics; 

\item avoiding academic, philosophical language;

\item encouraging contextual adaption.\footnote{If you would like to discuss translating MPD resources, for printing and distribution in another language, please visit http:/\slash maizeplantdiscipleship.info}

\end{itemize}

\subsection{Published according to a missional philosophy}
\label{publishedaccordingtoamissionalphilosophy}

Hence, Maize Plant Discipleship resources are being licensed for reproduction under the terms of a \emph{Creative Commons} licence (\autoref{licence}), which 

\begin{itemize}
\item respects and maintains the copyright of the author and translators, yet

\item releases the traditionally tight, commercial control of copyright owners and publishers and thus
...
A Burkinabé theological educator, examining a prototype Maize Plant Discipleship booklet, stated:
