\def\version{0.4.1 --- Translation Draft}
...
: the \emph{sweet talk} of proverbs can provide fresh insight and be helpful in discussing discipleship and biblical teaching with others, such as elders or non-believers.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=299pt,height=271pt]{mp-metaphor.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=283pt,height=142pt]{roots.png}
\label{roots.png}
\end{figure}
