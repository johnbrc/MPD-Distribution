...
\def\subtitle{Maize Plant Discipleship}
\def\module{fh}
\def\translation{}
...
\item[The goal of discipleship{\ldots}]
...
— when planning a timetable, consider the group's availability: are members affected by agricultural seasons, or academic terms?
\end{description}
...
In-depth study of the treasury of Scripture references in the footnotes and use of discussion questions as a basis for written answers or even short essays, allows handbooks to facilitate other forms of guided learning:
...
In this way, practice informs theory and theory informs practice. As this learning process is repeated, it forms a \emph{cycle}, which can be illustrated figuratively.
...
— its purpose is to facilitate, not control learning and it may not be essential to incorporate every element, every time a group meets. Allow the cycle to stretch, but not to limit. \emph{Where appropriate, adapt it}. For example, groups could incorporate two (or more) studies into a single gathering, repeating the first three elements of the cycle, before moving on to the final three.
\end{description}
...
\item Dynamics of growth (Modules 2--9)
...
\subsubsection{Module 7 : Truth}
\label{module7:truth}

\begin{itemize}
\item Encountering truth as we walk in practical, covenantal faithfulness towards God's revelation, wisdom and direction.

\end{itemize}

\subsubsection{Module 8 : Intercession}
\label{module8:intercession}
...
\subsubsection{Module 9 : Cultural transformation}
\label{module9:culturaltransformation}
...
Modules 10 to 16 examine seven characteristic \emph{disciplines} that enable messianic communities to receive the revelatory \emph{light} and sustaining \emph{living water} of God's Spirit, without which we become spiritually weak and incapable of producing good fruit or a plentiful harvest.
...
\subsubsection{Module 10 : Spiritual Maturity}
\label{module10:spiritualmaturity}
...
\subsubsection{Module 11 : Running the Race}
\label{module11:runningtherace}
...
\subsubsection{Module 12 : Pressing Toward Our Vocation}
\label{module12:pressingtowardourvocation}
...
\subsubsection{Module 13 : Economic Faithfulness}
\label{module13:economicfaithfulness}
...
\subsubsection{Module 14 : Messianic Leadership}
\label{module14:messianicleadership}
...
\subsubsection{Module 15 : Living by Faith}
\label{module15:livingbyfaith}
...
\subsubsection{Module 16 : Overcoming}
\label{module16:overcoming}
...
— its use may be encouraged and utilised as appropriate, particularly during group discussions and especially for Scripture reading and memorisation.
\end{description}
...
\item Consider the various ways that maize is important in your context. What might this suggest to you about the importance of the messianic community to a social or cultural context?
...
\textbf{Generational discipleship is how treasure is kept safe in the kingdom of God. The significance of the principle of generational discipleship can be further illustrated by considering the metaphor of \emph{seeds} and the harvest that comes from sowing seeds into good soil.}
\end{quote}
...
\textbf{People willing to be transformed through a personal knowledge and experience of the Messiah, who will share their treasure with other faithful people {\ldots} who will share it with other faithful people and so on and so forth.}
\end{quote}
...
\textbf{Establishing a truly transformational movement requires a vision capable of gripping the hearts of others and forming them into faithful disciples}: 
\end{quote}
...
In this latest stage of development, \emph{doctoral research} carried out amongst Burkinabé leaders and learners has led to Maize Plant Discipleship's formulation as a series of low-cost, modular handbooks. Handbooks that are practical, relevant and accessible for use in African contexts.
...
\begin{itemize}
\item Focuses on practical discipleship formation

\item Eschews academic, philosophical language

\item Follows thematic, modular structure
...
\item Licensed for vernacular adaption, translation, re-publication

\item Designed for economic reproduction, distribution
...
It is hoped that Maize Plant Discipleship handbooks may eventually be translated, republished and adopted for use in many African and other Majority World contexts. 

We welcome hearing from those who have explored and trialled it. Please tell us where, how and with what effect you are using it, together with any suggestions you would like to offer. We would especially enjoy hearing of stories, proverbs, metaphors that help to illustrate and culturally illuminate Maize Plant Discipleship teaching.
