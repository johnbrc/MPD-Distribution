\def\version{0.5.6 --- Final draft}
\def\change{ARTaplin (final) edits}
\input{mpd-header}
...
\section{4. SHARE bread together}
\label{sharebreadtogether}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=284pt,height=400pt]{mp-disciplines.png}
