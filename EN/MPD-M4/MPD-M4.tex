\def\version{0.5.6 Sample print copy}
\def\change{bar code added}
\input{mpd-header}
...
A soldier's life starts when they perceive a \emph{calling} to a life of military service. A calling is an awareness that a particular occupation represents a desirable, compelling, or appropriate vocation to pursue. There may be many reasons why someone enlists in an army, but at some point they sense a personal calling towards it.
...
Discuss (i) the responsibility implied by the giving and receiving of a commission and (ii) how the \emph{duty} of being commissioned differs from the \emph{discipline} of basic training.
...
\section{Strategy of prayer}
\label{strategyofprayer}
...
\section{Strategy of reconciliation}
\label{strategyofreconciliation}
...
\item What issues hinder you, your household and family, from personally experiencing reconciliation and peace with God?

\end{itemize}

\end{discuss}

\section{Strategy of discipleship}
\label{strategyofdiscipleship}
...
Because discipleship deals with the heart, strategically and practically it should \emph{precede} concentrated biblical teaching (\autoref{strategyofteaching}), which is for committed disciples who have progressed beyond the elementary teachings.
...
\section{Strategy of teaching}
\label{strategyofteaching}
...
The writer of Hebrews talks about \emph{solid food}, or \emph{strong meat,\footnote{The KJV phrase, \emph{strong meat}, captures well the sense of maturity required to ingest and digest challenging scriptural teaching.}} as a metaphor for the challenging teaching of God's word. He chastises his readers that they should be teaching others by this time, yet instead they still need \emph{milk}—a metaphor for elementary teaching.\footnote{Hebrews 6:1--3}
...
\section{Strategy of sending}
\label{strategyofsending}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=259pt,height=236pt]{cycle.png}
\label{cycle.png}
\end{figure}
...
\textbf{Scripture reveals a cycle of five major strategies empowering the mission of the Messianic community}, which may be summarised: Pray, Reconcile, Disciple, Teach, Send
...
\begin{figure}[htbp]
\centering
\includegraphics[width=140pt,height=140pt]{pastoral.png}
\label{pastoral.png}
\end{figure}
\begin{description}
...
This pastoral-evangelistic character is most visibly expressed through community \emph{faithfulness}, \emph{hospitality} and \emph{celebration}.
...
\textbf{Discipling people into faithful allegiance to God's Messiah} — facilitating and encouraging significant spiritual and practical expressions of faithfulness: in homes, workplaces and places where community is built and enhanced.
...
Teaching and training centres supplement the formation of disciples taking place within pastoral, evangelistic communities (\autoref{pastoralevangelisticcommunities}). 

\begin{figure}[htbp]
\centering
\includegraphics[width=150pt,height=150pt]{teaching.png}
\label{teaching.png}
\end{figure}



Their function is to equip mature messianic disciples for missional, vocational service, in both \emph{intra-cultural} and \emph{inter-cultural} contexts, between which there are significant differences, yet which together signify the full scope of messianic mission: God's servant community, blessed to be a blessing to \emph{all the peoples} of the world.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=239pt,height=250pt]{prophetic.png}
\label{prophetic.png}
\end{figure}
...
The prophetic role may be thought of as \emph{listening to and discerning God's heart}.\footnote{See \emph{Module 8: Intercession}, for further discussion of this concept.} This implies a significant level of spiritual intimacy, enabling prophets to:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=268pt,height=276pt]{heartbeat.png}
\label{heartbeat.png}
\end{figure}
...
You are{\ldots}members of the household of God, built upon the foundation of the apostles and prophets, with Christ himself as the cornerstone. 

In him the whole structure is joined together and grows into a holy temple in the Lord, in whom you also are being built spiritually into a dwelling place for God—\emph{Ephesians 2:19ff ABV}
\end{quote}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=294pt,height=255pt]{interactions2.png}
...
\begin{itemize}
\item Briefly discuss each of the identified interactions, between the three foundational structures. 

\item Which of these structural dynamics are most significant? Why?
...
\begin{itemize}
\item the foundational structures of messianic community,

\item including their relation to the five foundational gifts of pastor, evangelist, teacher, apostle and prophet and

\item the five foundational strategies of pray, reach, disciple, teach, send.
...
\textbf{The messianic community has a God-ordained structure}, which uniquely equips it to fulfil the messianic commission
...
Bee colonies exhibit growth through organic, steady, cyclical \textbf{increase} in bee numbers. This leads to swarming and eventually a \textbf{division} of the colony, which then \textbf{expands} into a different geographical region.
...
Organic \textbf{increase} in plant growth potentially produces a thousand-fold \textbf{multiplication} of seeds, often twice a year, allowing rapid crop \textbf{expansion}, depending upon climate and soil conditions.
...
Once through the surface, the plants leaves can begin \emph{photosynthesising} sunlight (turning light into growth!), while its roots continue drawing on soil nutrients and moisture. In arid locations, typical of Africa, the most significant growth factor is a sufficiency of rainfall.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=221pt,height=190pt]{maize.png}
\label{maize.png}
\end{figure}
\begin{description}
...
Commercial growth is typically measured by an \textbf{increase} in profits, personnel and management experience, leading to \textbf{duplication} of structures (premises and management hierarchy) and geographical \textbf{expansion} of the market being served.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=175pt,height=140pt]{increase.png}
\label{increase.png}
\end{figure}
\begin{description}
...
An \textbf{increase} in the fruitfulness amongst missional movements is measured in terms of disciples within whom there is a faithful \textbf{reproduction} of the life of the Spirit, including the missional vision to make disciples amongst people of all nations. This leads to a \textbf{expansion} in the Gospel's social and cultural sphere of influence.

\subsection{Increase}
\label{mvmts}

Missional movements grow through the forming of disciples who make disciples, who make disciples—as discussed in \emph{Commissioning of Messianic Community} (\autoref{commissioningofmessianiccommunity}) and \emph{Structures of Messianic Community} (\autoref{structuresofmessianiccommunity}). Disciples do more than simply \emph{believe} in missional values: they \emph{embody} core beliefs and values by realigning their lives, in order to affect their own contexts and futures—including making disciples {\ldots} who make disciples {\ldots} who make disciples and so on.
...
\begin{itemize}
\item explored three examples of either organic or organisational reproduction, in order to compare and contrast them with the organised expansion of messianic, discipleship movements. 

\item highlighted characteristics associated with the growth, reproduction, relocation, harvest and risks of swarming bees, maize plants, commercial organisations and missional movements. 
