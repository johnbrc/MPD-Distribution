\def\version{0.5.5 Post-translation}
\def\change{amended images, added syllabus, cover pages}
\input{mpd-header}
\def\mytitle{Dynamics of Commissioning}
\def\subtitle{Module 4}
\def\module{4}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=266pt,height=251pt]{commissioncycle2.png}
\label{commissioncycle2.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=150pt,height=150pt]{pastoral.png}
\label{pastoral.png}
\end{figure}
\begin{description}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=317pt,height=237pt]{prophetic-mediation.png}
\label{prophetic-mediation.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=299pt,height=235pt]{heartbeat.png}
\label{heartbeat.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=273pt,height=238pt]{interactions.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=227pt,height=200pt]{maize-plants.png}
