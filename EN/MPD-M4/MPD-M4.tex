\def\version{0.5.4 Post-translation}
\def\change{ammended in parallel with M4-FR:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=210pt,height=225pt]{commissioncycle.png}
...
\textbf{Scripture reveals a cycle of five major strategies empowering the mission of the Messianic community}, which may be summarised: Pray, Reach, Disciple, Teach, Send
