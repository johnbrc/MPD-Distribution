\def\version{0.5.2 Post-translation}
\def\change{Tweaked, in parallel with FR translation
Amended order of topical sub-sections}
\input{mpd-header}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=150pt]{maize-plants.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[height=140pt]{commerce.png}
\label{commerce.png}
\end{figure}
\begin{description}
