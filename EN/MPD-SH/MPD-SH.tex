...
\chapter{The Learning Groups}
\label{thelearninggroups}
...
Maize Plant Discipleship is a \emph{learning}, rather than a teaching resource. Learning depends on many factors, beyond the presentation of topical information. Most depend on the student, rather than the teacher and teaching. Factors include desire, temperament, experience, talent, time, energy, environment and so forth.
...
\begin{itemize}
\item fed by life-giving spiritual nutrients

\item refreshed with the living water of the Spirit

\item stimulated by the light of God's revelation.
...
Based on this metaphor, the fifteen Syllabus modules are divided into two main sections: \emph{Roots and Harvests} and \emph{Sunlight and Rainfall}.

\begin{figure}[htbp]
\centering
\includegraphics[width=309pt,height=460pt]{mp-metaphor-applied@2x.png}
\label{mp-metaphor-applied2x.png}
\end{figure}

\subsection{Roots and Harvests — Messianic Dynamics}
\label{rootsandharvests—messianicdynamics}

\emph{Modules 1 to 8} examine eight messianic dynamics. These dynamics represent the roots, growth and harvests of the Messianic Community.⁠.\footnote{\emph{Dynamic} derives from a Greek word, \emph{dunamis}, meaning power and refers to forces stimulating change within a process or system, such as a plant or a body.}

\subsubsection{1 — Eternal Purpose}
\label{1—eternalpurpose}

\begin{itemize}
\item The root of the syllabus. The Messiah represents the fullness of Gods eternal purpose. The Seed that grows in the soil of the Israel. A Seed that produces a rich harvest of people from the earth.
...
\begin{itemize}
\item The Messianic Community has received a commission from God. This is how they join the Messiah's mission towards the world.
...
\begin{itemize}
\item The Messianic Community has a unique and special vocation: to bless the nations of the world.
...
\begin{itemize}
\item The Messianic Community has a special responsibility towards the Jewish people.
...
\begin{itemize}
\item The body of the Messiah is called to fully express his life. This requires progressive corporate growth into spiritual maturity.
...
\begin{itemize}
\item The pathway towards a fruitful harvest is to walk in practical and spiritual faithfulness.
...
\begin{itemize}
\item The Messianic Community has a priestly calling to be \emph{a house of prayer for all nations}.
...
\begin{itemize}
\item The Messianic Community is called to work amongst and on behalf of the nations of the world. It's goal is to establish cultural transformations that signal the presence of God's kingdom.
...
\emph{Modules 9 to 15} examine seven key disciplines that feed the growth of the Messianic Community. These disciplines represent the light and living water of God's Spirit.

\subsubsection{9 — Maturity}
\label{9—maturity}

\begin{itemize}
\item The spiritual growth of Messianic disciples and communities incorporates three distinct phases.
...
\begin{itemize}
\item An enduring life of service relies upon nurturing essential motivations, virtues and disciplines.
...
\begin{itemize}
\item A deepening relationship with the Messiah is the foundation of personal vocation.
...
\begin{itemize}
\item Scriptural perspectives upon economic faithfulness, wealth and poverty are radically different to those of the world in general.
...
\begin{itemize}
\item Faithful messianic leadership requires the nurture of essential motivations, qualities and disciplines.
...
\begin{itemize}
\item Seeing with eyes of faith enables us to endure times of testing and purification. We learn to embrace challenge as an opportunity for experiencing God's faithfulness.
...
\begin{itemize}
\item Overcoming in the power of the Spirit leads to confrontation with idolatrous, cultural strongholds.
...
\item How would you describe the significance of a messianic \emph{dynamic}?

\item Consider the importance of maize in your context. What could this suggest about the importance of the messianic community to a social or cultural context?
...
The apostle, Paul, explains the essence of \emph{messianic discipleship} to his disciple, Timothy:⁠
