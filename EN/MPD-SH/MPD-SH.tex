...
— \emph{see The Philosophy (\autoref{thephilosophy}) for further discussion} — it may not be necessary for a group member to complete the entire syllabus before branching out to facilitate another learning group; be led by the Spirit.
\end{description}
...
\item[The syllabus incorporates \ensuremath{\sim}240 topics, in 60 studies]
...
\begin{figure}[htbp]
\centering
\includegraphics[width=229pt,height=230pt]{reflective-learning@2x.png}
\label{reflective-learning2x.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=256pt,height=284pt]{mpd-learning-cycle@2x.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=190pt,height=270pt]{mpd-metaphor@2x.png}
\label{mpd-metaphor2x.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=180pt,height=124pt]{mp-roots@2x.png}
\label{mp-roots2x.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=255pt,height=373pt]{mp-dynamics@2x.png}
\label{mp-dynamics2x.png}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=280pt,height=398pt]{mp-disciplines@2x.png}
\label{mp-disciplines2x.png}
\end{figure}
...
\begin{itemize}
\item Spiritual growth and maturity in the vocational engagement of messianic disciples and communities.
...
\item Published according to a non-commercial, missional philosophy
