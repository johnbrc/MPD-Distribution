Version: 0.5.4 FR Post-translation
Change: ammended in parallel with M4:
...
Décrire (i) la responsabilité conférée par le don et la réception d'une commission and (ii) comment le *devoir* d'une commission diffère-t-il de la *discipline* de la formation de base.
...
Ceci conclut l'Étude 2, qui a exploré cinq stratégies missionnaires de base : 

-	la prière stratégique
-	la réconciliation avec Dieu
-	la formation de disciples
-	l'enseignement des gens spirituellement matures et 
-	leur envoi en mission. 
...
<!--\tsection{Le battement du cœur de Dieu}-->

![][battement-du-coeur.png]
...
| réconciliez, faire des disciples|communautés pastorales évangéliques|conduire dans l'allégeance|
...
Ceci conclut l'Étude 3, qui a examiné :

-	les structures de base de la communauté messianique, 
-	y compris leur relation avec les cinq dons fondamentaux de pasteur, d'évangéliste, d'enseignant, d'apôtre, et de prophète et 
-	les cinq stratégies fondamentales de prier, atteindre, faire des disciples, enseigner et envoyer. 
...
Décrire (i) comment le ministère prophétique équilibre-t-il les interactions entre les trois structures messianiques et (ii) comment explorer la correspondance envers les dons et les aperçus prophétiques ?
...
### Accroissement [accroissement-mvmts] ###
...
Reproduction in a missional movement is never merely a numerical eventuality. Discipleship is ultimately about a reproduction of the life of Jesus, within a community of people, by the power of his Spirit.
...
Ceci met fin à l'étude 4, qui a 

-	exploré trois exemples de reproduction soit organique ou organisationnel, en vue d'établir les similitudes et les divergences entre ces types et l'expansion organisée des mouvements méssianiques de discipolat. 

-	mis en lumière les caratéristiques en termes de croissance, de reproduction, de relocalisation, de moisson et des risques liés à l'essaim des abeilles, aux plantes de maïs, aux organisations commerciales et aux mouvements missionnaires. 
...
[priez.png]: priez.png width=95px height=39px

[reconciliez.png]: reconciliez.png width=178px height=39px

[faire.png]: faire.png width=261px height=39px

[enseigner.png]: enseigner.png width=271px height=31px

[envoyer.png]: envoyer.png width=303px height=27px

[cycle.png]: cycle.png width=151px height=140px

[communautés.png]: communautés.png width=125px height=125px

[allegeance.png]: allegeance.png width=124px height=125px

[centres.png]: centres.png width=125px height=125px

[verite.png]: verite.png width=125px height=125px

[equipes.png]: equipes.png width=125px height=125px

[puissance.png]: puissance.png width=125px height=125px

[mediation.png]: mediation.png width=245px height=240px

[battement-du-coeur.png]: battement-du-coeur.png width=249px height=241px

[interactions.png]: interactions.png width=251px height=240px

[division.png]: division.png width=271px height=59px

[swarm-bw.png]: swarm-bw.png width=110px height=150px

[multiplication.png]: multiplication.png width=271px height=59px

[maize-plants.png]: maize-plants.png width=198px height=175px

[duplication.png]: duplication.png width=271px height=59px

[commerce.png]: commerce.png width=152px height=160px

[reproduction.png]: reproduction.png width=271px height=59px
